...
//MATERIALS 29000-30000 RESERVED FOR ELEMENTS
//MATERIALS 31000-32727 RESERVED FOR ISOTOPES

//----------------------------------ELEMENTS---------------------------------

MaterialBuilder(29000, "iodine")
.element("Iodine")
.dust()
.color(0x390b6e)
.build();

MaterialBuilder(29001, "hafnium")
.element("Hafnium")
.dust()
.ingot()
.color(0x1c1b18)
...
MaterialBuilder(29002, "chromium")
.element("Chromium")
.dust()
.ingot()
.color(0xccb8c7)
...
MaterialBuilder(29003, "strontium")
.element("Strontium")
.dust()
.ingot()
.color(0xdbdaab)
...
generateHotLiquid("air", 10200);

generateHotLiquid("brine", 10201);
...
generateThermoRefrigerant("propane", 10303);

generateThermoRefrigerant("carbon_dioxide", 10306);
...
//Liquid Helium-3
MaterialBuilder(11026, "liquid_heliumb")
.fluid()
.fluidTemp(4)
.flags(["disable_decomposition"])
.components([<material:helium_3> * 1])
.colorAverage()
.build();

//Condensed Helium
MaterialBuilder(11027, "condensed_helium")
.fluid()
.fluidTemp(77)
.flags(["disable_decomposition"])
.components([<material:helium_3> * 1])
...
//Enriched Helium
MaterialBuilder(11028, "enriched_helium")
.fluid()
.flags(["disable_decomposition"])
.components([<material:helium> * 1, <material:helium_3> * 1])
.colorAverage()
.build();

//Liquid Helium-3
MaterialBuilder(11029, "superfluid_helium")
.fluid()
.fluidTemp(1)
.flags(["disable_decomposition"])
.components([<material:helium> * 1])
.colorAverage()
.build();
