...
<ore:gregAxes>.addItems([
	<gregtech:meta_tool:3>.withEmptyTag()
]);

<ore:gregFiles>.addItems([
	<gregtech:meta_tool:9>.withEmptyTag()
]);

<ore:gregSwords>.addItems([
...
<ore:gregBranchCutters>.addItems([
	<gregtech:meta_tool:15>.withEmptyTag()
]);

<ore:gregWireCutters>.addItems([
	<gregtech:meta_tool:13>.withEmptyTag()
]);

<ore:gregHardHammers>.addItems([
	<gregtech:meta_tool:6>.withEmptyTag()
]);

<ore:gregSoftHammers>.addItems([
