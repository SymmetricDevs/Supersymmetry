...
class ThirdDegreeMaterials {
    ...
    static Material genSolution(int id, String name, Material solute, Material solvent, boolean is_acid) {
        def builder = new Material.Builder(id, SuSyUtility.susyId(name))
                ...
                .colorAverage()
        if (is_acid) {
            builder = builder.liquid(new FluidBuilder().acidic())
        } else {
    ...
    static void register() {
        ...
        // FREE IDs: 24150-24155

        ElectrolyticCapacitorElectrolyte = new Material.Builder(24156, SuSyUtility.susyId("electrolytic_capacitor_electrolyte"))
                .liquid()
