...
public class UnknownCompositionMaterials {
    ...
    public static void register() {
        ...
        NickelExtractionMixture = new Material.Builder(4437, SuSyUtility.susyId("nickel_extraction_mixture")) //delete
                .fluid()
                .color(0xe60e0e)
                .build();
        ...
        NickelCobaltSulfateSolution = new Material.Builder(4440, SuSyUtility.susyId("nickel_cobalt_sulfate_solution"))
                .fluid()
                .color(0xe60e0e)
                .build();
        ...
        OsmiumFreePGMSolution = new Material.Builder(4447, SuSyUtility.susyId("osmium_free_pgm_soluion"))
                .fluid()
                .color(0xe0dcb6)
                .build();
