...
class OreMaterials {
    static void register() {
        ...
        Polarite.setFormula('Pd(Bi,Pb)', true)
        ...
        Kernite.setFormula('Na2B4O6(OH)2 * (H2O)3', true)
        ...
        Colemanite.setFormula('Ca2B6O11 * (H2O)5', true)
        ...
        Ulexite.setFormula('NaCaB5O6(OH)6 * (H2O)5', true)
        ...
        Carnallite.setFormula('KCl.MgCl2 * (H2O)6', true)
        ...
        Kainite.setFormula('KMg(SO4)Cl * (H2O)3', true)
        ...
        Kieserite.setFormula('MgSO4 * H2O', true)
        ...
        Polyhalite.setFormula('K2Ca2Mg(SO4)4 * (H2O)2', true)
        ...
        Mimetite.setFormula('Pb5(AsO4)3Cl', true)
        ...
        Pyromorphite.setFormula('Pb5(PO4)3Cl', true)
        ...
        Descloizite.setFormula('(Pb,Zn)2VO4OH', true)
        ...
        Mottramite.setFormula('PbCu(VO4)(OH)', true)
        ...
        Chlorapatite.setFormula('Ca5(PO4)3Cl', true)
        ...
        Allanite.setFormula('(Ce,Ca,Y,La)2(Al,Fe)3(SiO4)3(OH)', true)
        ...
        Goethite.setFormula('α-FeO(OH)', true)
        ...
        Columbite.setFormula('(Fe,Mn)Nb2O6', true)
        ...
        Ferrimolybdite.setFormula('Fe2(MoO4)3 * (H2O)8', true)
        ...
        Braggite.setFormula('(Pt,Pd,Ni)S', true)
        ...
        Euxenite.setFormula('(REE,U,Th)(Nb,Ta,Ti)2O6', true)
        ...
        Xenotime.setFormula('(REE)PO4', true)
        ...
        Lauterite.setFormula('Ca(IO3)2', true)
        ...
        Langbeinite.setFormula('K2Mg2(SO4)3', true)
        ...
        Hydroxyapatite.setFormula('Ca5(PO4)3OH', true)
