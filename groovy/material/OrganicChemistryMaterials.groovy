...
public class OrganicChemistryMaterials {
    public static void register() {
        ...
        Bromoform = new Material.Builder(15285, SuSyUtility.susyId("bromoform"))
                .fluid()
                .components(Carbon, 1, Hydrogen, 1, Bromine, 3)
                .color(0x77042d)
                .build();

        SodiumAcetate = new Material.Builder(15286, SuSyUtility.susyId("sodium_acetate"))
                .dust().fluid()
                .components(Carbon, 2, Hydrogen, 3, Oxygen, 2, Sodium, 1)
                .color(0xf4f7ff)
                .build();

        Methylidynetricobaltnonacarbonyl = new Material.Builder(15287, SuSyUtility.susyId("methylidynetricobaltnonacarbonyl"))
                .dust()
