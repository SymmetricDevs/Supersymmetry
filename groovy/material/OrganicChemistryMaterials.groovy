...
class OrganicChemistryMaterials {
    static void register() {
        ...
        DiTertButylDicarbonateSolution = new Material.Builder(15530, SuSyUtility.susyId('di_tert_butyl_dicarbonate_solution'))
                .liquid()
                .components(DiTertButylDicarbonate, RockSaltSolution)
                .colorAverage()
                .build()
        ...
        ProtectedHydroxystyreneSolution = new Material.Builder(15532, SuSyUtility.susyId('protected_polyhydroxystyrene_solution'))
                .liquid()
        ...
        DryFilmPhotoresist = new Material.Builder(15537, SuSyUtility.susyId('dry_film_photoresist'))
                .polymer()
                .components(Mylar, PolymethylMethacrylate)
                .colorAverage()
                .flags(GENERATE_FOIL)
                .build()
        ...
        EthylLactate = new Material.Builder(15546, SuSyUtility.susyId('ethyl_lactate'))
                ...
                .colorAverage()
                .setFormula('CH3CH(OH)CO2CH2CH3')
                .build()

        EthylLactateSolution = new Material.Builder(15546, SuSyUtility.susyId('ethyl_lactate_solution'))
                .liquid()
        ...
        ParaAzidoBenzaldehydeSolution = new Material.Builder(15553, SuSyUtility.susyId('para_azidobenzaldehyde_solution'))
                .liquid()
                .components(ParaAzidoBenzaldehyde, SodiumChlorideSolution)
                .colorAverage()
                .build()
        ...
        OneFiveNaphthalenedisulfonicAcid = new Material.Builder(15558, SuSyUtility.susyId('one_five_naphthalenedisulfonic_acid'))
                ...
                .colorAverage()
                .setFormula("C10H6(SO2OH)2")
                .build()

        SodiumOneNaphtholFiveSulfonate = new Material.Builder(15560, SuSyUtility.susyId('sodium_one_naphthol_five_sulfonate'))
                .dust()
                .components(Carbon * 10, Hydrogen * 7, Oxygen * 4, Sulfur * 1, Sodium)
                .colorAverage()
                .setFormula("Na(C10H6OHSO3)")
                .build()
        ...
        DiazonaphthoquinoneSulfonicAcid = new Material.Builder(15563, SuSyUtility.susyId('diazonaphthoquinone_sulfonic_acid'))
                .dust()
                .components(Carbon * 10, Hydrogen * 6, Nitrogen * 2, Oxygen * 4, Sulfur)
                .colorAverage()
                .setFormula("C10H6N2SO4")
                .build()

        DiazonaphthoquinoneSulfonylChloride = new Material.Builder(15564, SuSyUtility.susyId('diaznoaphthoquinone_sulfonyl_chloride'))
                .dust()
                .components(Carbon * 10, Hydrogen * 5, Nitrogen * 2, Oxygen * 4, Sulfur, Chlorine)
                .colorAverage()
                .setFormula("C10H5N2SO4Cl")
                .build()
        ...
        DiazonaphthoquinoneFiveSulfonateEsterSolution = new Material.Builder(15569, SuSyUtility.susyId('diazonaphthoquinone_five_sulfonate_ester_solution'))
                .liquid()
                .components(TwoThreeFourTrihydroxybenzophenone, DiazonaphthoquinoneSulfonylChloride * 3, Acetone)
                .colorAverage()
                .build()
