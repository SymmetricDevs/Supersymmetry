...
class OrganicChemistryMaterials {
    static void register() {
        ...
        DimethylAniline = new Material.Builder(15540, SuSyUtility.susyId('dimethyl_aniline'))
                .liquid()
                .components(Carbon * 8, Hydrogen * 11, Nitrogen)
                .color(0xc1c4a4)
                .build()
        DimethylAniline.setFormula('C6H5N(CH3)2')

        DimethylAnilineSolution = new Material.Builder(15541, SuSyUtility.susyId('dimethyl_aniline_solution'))
                .liquid()
                .components(DimethylAniline, Water)
                .colorAverage()
                .build()
        ...
        SodiumOneNaphtholFiveSulfonate = new Material.Builder(15573, SuSyUtility.susyId('sodium_one_naphthol_five_sulfonate'))
                .dust()
