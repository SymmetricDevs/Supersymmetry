...
class OrganicChemistryMaterials {
    static void register() {
        ...
        FluorinatedMethanesulfonicAcidMixture = new Material.Builder(15525, SuSyUtility.susyId('fluorinated_methanesulfonic_acid_mixture'))
                .liquid()
                .components(MethanesulfonicAcid, HydrogenFluoride)
                .colorAverage()
                .build()
        ...
        PolyhydroxystyreneSolution = new Material.Builder(15527, SuSyUtility.susyId('polyhydroxystyrene_solution'))
                .liquid()
                .components(Polyhydroxystyrene, Dimethylformamide)
                .colorAverage()
                .build()
        ...
        PotassiumTertButoxide = new Material.Builder(15528, SuSyUtility.susyId('potassium_tert_butoxide'))
                ...
                .colorAverage()
                .build()
        PotassiumTertButoxide.setFormula('KC4H9O')
        ...
        DiTertButylDicarbonateSolution = new Material.Builder(15530, SuSyUtility.susyId('di_tert_butyl_dicarbonate_solution'))
                .liquid()
                .components(DiTertButylDicarbonate, PotassiumChlorideSolution)
                .colorAverage()
                .build()
        ...
        ProtectedPolyhydroxystyreneSolution = new Material.Builder(15532, SuSyUtility.susyId('protected_polyhydroxystyrene_solution'))
                .liquid()
        ...
        ParaEthylbenzenesulfonicAcidSolution = new Material.Builder(15534, SuSyUtility.susyId('para_ethylbenzenesulfonic_acid_solution'))
                .liquid()
                .components(ParaEthylbenzenesulfonicAcid, Water)
                .colorAverage()
                .build()
        ...
        ParaEthylphenol = new Material.Builder(15535, SuSyUtility.susyId('para_ethylphenol'))
                ...
                .colorAverage()
                .build()
        ParaEthylphenol.setFormula('C8H9OH')
        ...
        ParaVinylphenol = new Material.Builder(15536, SuSyUtility.susyId('para_vinylphenol'))
                ...
                .colorAverage()
                .build()
        ParaVinylphenol.setFormula('C8H7OH')
        ...
        MichlersKetone = new Material.Builder(15538, SuSyUtility.susyId('michlers_ketone'))
                ...
                .colorAverage()
                .build()
        MichlersKetone.setFormula('[(CH3)2NC6H4]2CO')

        AcrylateResistMixture = new Material.Builder(15539, SuSyUtility.susyId('acrylate_resist_mixture'))
                .liquid()
        ...
        DimethylAniline = new Material.Builder(15540, SuSyUtility.susyId('dimethylaniline'))
                ...
                .color(0xc1c4a4)
                .build()
        DimethylAniline.setFormula('C8H11N')

        DimethylAnilineSolution = new Material.Builder(15541, SuSyUtility.susyId('dimethylaniline_solution'))
                .liquid()
        ...
        PropyleneGlycol = new Material.Builder(15542, SuSyUtility.susyId('propylene_glycol'))
                ...
                .colorAverage()
                .build()
        PropyleneGlycol.setFormula('CH3CH(OH)CH2OH')
        ...
        PropyleneGlycolMethylEther = new Material.Builder(15543, SuSyUtility.susyId('propylene_glycol_methyl_ether'))
                ...
                .colorAverage()
                .build()
        PropyleneGlycolMethylEther.setFormula('C4H10O2')
        ...
        PropyleneGlycolMethylEtherAcetateSolution = new Material.Builder(15545, SuSyUtility.susyId('propylene_glycol_methyl_ether_acetate_solution'))
                .liquid()
                .components(PropyleneGlycolMethylEtherAcetate, Water)
                .colorAverage()
                .build()
        ...
        EthylLactateSolution = new Material.Builder(15572, SuSyUtility.susyId('ethyl_lactate_solution'))
                .liquid()
                .components(EthylLactate, Water)
                .colorAverage()
                .build()
        ...
        BisAzideCrosslinker = new Material.Builder(15549, SuSyUtility.susyId('bis_azide_crosslinker'))
                ...
                .colorAverage()
                .build()
        BisAzideCrosslinker.setFormula('C21H18N6O')

        NovolacLiftoffResist = new Material.Builder(15548, SuSyUtility.susyId('novolac_liftoff_resist'))
                .liquid()
                .components(PhenolicNovolacResin, EthylLactate, PropyleneGlycolMethylEtherAcetate, BisAzideCrosslinker)
                .colorAverage()
                .build()

        BisAzideCrosslinkerSolution = new Material.Builder(15550, SuSyUtility.susyId('bis_azide_crosslinker_solution'))
                .liquid()
                .components(BisAzideCrossLinker, Water)
                .colorAverage()
                .build()
        ...
        FourMethylcyclohexanone = new Material.Builder(15551, SuSyUtility.susyId('four_methylcyclohexanone'))
                ...
                .colorAverage()
                .build()
        FourMethylcyclohexanone.setFormula("C7H12O")
        ...
        ParaAzidobenzaldehydeSolution = new Material.Builder(15553, SuSyUtility.susyId('para_azidobenzaldehyde_solution'))
                .liquid()
                .components(ParaAzidobenzaldehyde, SaltWater)
                .colorAverage()
                .build()
        ...
        ParaDiazoBenzaldehydeChlorideSolution = new Material.Builder(15554, SuSyUtility.susyId('para_diazobenzaldehyde_chloride_solution'))
                ...
                .colorAverage()
                .build()
        ParaDiazoBenzaldehydeChlorideSolution.setFormula("ClC7H5N2O")
        ...
        ParaAminobenzaldehyde = new Material.Builder(15555, SuSyUtility.susyId('para_aminobenzaldehyde'))
                ...
                .colorAverage()
                .build()
        ParaAminobenzaldehyde.setFormula("C7H7NO")

        NovolacEBRSolvent = new Material.Builder(15556, SuSyUtility.susyId('novolac_ebr_solvent'))
                .liquid()
                .components(PropyleneGlycolMethylEther * 7, PropyleneGlycolMethylEtherAcetate * 3)
                .colorAverage()
                .build()

        NaphthalenedisulfonicAcidSolution = new Material.Builder(15557, SuSyUtility.susyId('naphthalenedisulfonic_acid_solution'))
                .liquid()
                .components(Naphthalene, Oleum * 6)
                .colorAverage()
                .build()
        ...
        OneFiveNaphthalenedisulfonicAcid = new Material.Builder(15558, SuSyUtility.susyId('one_five_naphthalenedisulfonic_acid'))
                ...
                .colorAverage()
                .build()
        OneFiveNaphthalenedisulfonicAcid.setFormula("C10H6(SO2OH)2")

        SodiumOneNaphtholFiveSulfonate = new Material.Builder(15613, SuSyUtility.susyId('sodium_one_naphthol_five_sulfonate'))
                .dust()
        ...
        SodiumNaphtholSulfonateSolution = new Material.Builder(15559, SuSyUtility.susyId('sodium_naphthol_sulfonate_solution'))
                .liquid()
                .components(SodiumOneNaphtholFiveSulfonate, Water)
                .colorAverage()
                .build()
        ...
        DiazonaphthoquinoneFiveSulfonylChloride = new Material.Builder(15564, SuSyUtility.susyId('diaznoaphthoquinone_five_sulfonyl_chloride'))
                ...
                .colorAverage()
                .build()
        DiazonaphthoquinoneFiveSulfonylChloride.setFormula("C10H5N2SO4Cl")
        ...
        GallicAcidSolution = new Material.Builder(15566, SuSyUtility.susyId('gallic_acid_solution'))
                .liquid()
                .components(GallicAcid, Water)
                .colorAverage()
                .build()
        ...
        Pyrogallol = new Material.Builder(15567, SuSyUtility.susyId('pyrogallol'))
                ...
                .colorAverage()
                .build()
        Pyrogallol.setFormula("C6H3(OH)3")
        ...
        TwoThreeFourTrihydroxybenzophenone = new Material.Builder(15568, SuSyUtility.susyId('two_three_four_trihydroxybenzophenone'))
                ...
                .colorAverage()
                .build()
        TwoThreeFourTrihydroxybenzophenone.setFormula("C13H10O4")

        DiazonaphthoquinoneFiveSulfonateEsterSolution = new Material.Builder(15569, SuSyUtility.susyId('diazonaphthoquinone_five_sulfonate_ester_solution'))
                .liquid()
                .components(TwoThreeFourTrihydroxybenzophenone, DiazonaphthoquinoneFiveSulfonylChloride * 3, Acetone)
                .colorAverage()
                .build()
        ...
        DiazonaphthoquinoneFiveSulfonateEster = new Material.Builder(15570, SuSyUtility.susyId('diazonaphthoquinone_five_sulfonate_ester'))
                ...
                .colorAverage()
                .build()
        DiazonaphthoquinoneFiveSulfonateEster.setFormula("C23H13N2SO7")

        NovolacResist = new Material.Builder(15571, SuSyUtility.susyId('novolac_resist'))
                .liquid()
        ...
        Sulfolene = Material.Builder(15572 , SuSyUtility.susyId('sulfolene'))
                .dust()
                .components(Carbon * 4, Hydrogen * 6, Oxygen * 2, Sulfur)
                .colorAverage()
                .build()
        Sulfolene.setFormula("C4H6O2S")

        TripropylamineTriflate = Material.Builder(15573, SuSyUtility.susyId('tripropylamine_triflate'))
                .dust()
                .components(Tripropylamine, TriflicAcid)
                .colorAverage()
                .build()
        TripropylamineTriflate.setFormula("(C9H21N)(CF3SO3H)")

        MethylmagnesiumChlorideSolution = Material.Builder(15574 , SuSyUtility.susyId('methylmagnesium_chloride_solution'))
                .liquid()
                .components(Carbon, Hydrogen * 3, Magnesium, Chlorine, Tetrahydrofuran * 6)
                .colorAverage()
                .build()
        
        Hexamethyldisilazane = Material.Builder(15586 , SuSyUtility.susyId('hexamethyldisilazane'))
                .liquid()
        ...
        HexamethyldisilazaneSolution = Material.Builder(15575 , SuSyUtility.susyId('hexamethyldisilazane_solution'))
                .liquid()
                .components(Hexamethyldisilazane, Hexane)
                .colorAverage()
                .build()

        ParaTertbutyliodobenzene = Material.Builder(15576 , SuSyUtility.susyId('para_tertbutyliodobenzene'))
                .liquid()
        ...
        Tricyclodecane = Material.Builder(15577 , SuSyUtility.susyId('tricyclodecane'))
                .dust()
                .components(Carbon * 10, Hydrogen * 16)
                .colorAverage()
                .build()
        Tricyclodecane.setFormula("C10H16")

        TriphenylsulfoniumTriflate = Material.Builder(15578 , SuSyUtility.susyId('triphenylsulfonium_triflate'))
                .dust()
                .components(Carbon * 18, Hydrogen * 15, Sulfur, TriflicAcid)
                .colorAverage()
                .build()
        TriphenylsulfoniumTriflate.setFormula("(C18H15S)(CF3SO3)")

        PolyhydroxystyreneResist = Material.Builder(15579 , SuSyUtility.susyId('polyhydroxystyrene_resist'))
                .liquid()
        ...
        TwoMethylTwoAdamantanol = Material.Builder(15580, SuSyUtility.susyId('two_methyl_two_adamantanol'))
                .dust()
                .components(Carbon * 11, Hydrogen * 18, Oxygen)
                .colorAverage()
                .build()
        TwoMethylTwoAdamantanol.setFormula("C11H18O")

        AlphaHydroxyGammaButyrolactone = Material.Builder(15581, SuSyUtility.susyId('alpha_hydroxy_gamma_butyrolactone'))
                .liquid()
                .components(Carbon * 4, Hydrogen * 6, Oxygen * 3)
                .colorAverage()
                .build()
        AlphaHydroxyGammaButyrolactone.setFormula("C4H6O3")

        TwoChloroanthraquinone = Material.Builder(15582 , SuSyUtility.susyId('two_chloroanthraquinone'))
                .dust()
                .components(Carbon * 14, Hydrogen * 7, Oxygen * 2, Chlorine)
                .colorAverage()
                .build()
        TwoChloroanthraquinone.setFormula('C14H7O2Cl')

        Sulfolane = Material.Builder(15583, SuSyUtility.susyId('sulfolane'))
                .liquid()
        ...
        NonaflicAcid = Material.Builder(15584, SuSyUtility.susyId('nonaflic_acid'))
                .liquid()
        ...
        NonaflicAcidSolution = Material.Builder(15585, SuSyUtility.susyId('nonaflic_acid_solution'))
                .liquid()
                .components(NonaflicAcid, HydrofluoricAcid)
                .colorAverage()
                .build()

        TwoAminoanthracene = Material.Builder(15588, SuSyUtility.susyId('two_aminoanthracene'))
                .dust()
                .components(Carbon * 14, Hydrogen * 11, Nitrogen)
                .colorAverage()
                .build()
        TwoAminoanthracene.setFormula("C14H11N")

        StyreneAnthracenylMaleimide = Material.Builder(15587, SuSyUtility.susyId('styrene_anthreacenyl_maleimide'))
                .dust()
                .components(Styrene, MaleicAnhydride, TwoAminoanthracene)
                .colorAverage()
                .build()

        StyreneAnthracenylMaleimideSolution = Material.Builder(15589 , SuSyUtility.susyId('styrene_anthreacenyl_maleimide_solution'))
                .liquid()
                .components(StyreneAnthracenylMaleimide, Water, Dimethylformamide)
                .colorAverage()
                .build()

        StyreneMaleicAnhydrideSolution = Material.Builder(15590, SuSyUtility.susyId('styrene_maleic_anhydride_solution'))
                .liquid()
                .components(Azobisisobutyronitrile, MaleicAnhydride, Styrene, Dimethylformamide)
                .colorAverage()
                .build()

        TertButylbenzene = Material.Builder(15591, SuSyUtility.susyId('tert_butylbenzene'))
                .liquid()
                .components(Carbon * 10, Hydrogen * 14)
                .colorAverage()
                .build()
        TertButylbenzene.setFormula("C10H14")

        AcidicParaTertButylnitrobenzeneMixture = Material.Builder(15592, SuSyUtility.susyId('acidic_para_tert_butylnitrobenzene_mixture'))
                .liquid()
                .components(TertButylbenzene, NitrationMixture)
                .colorAverage()
                .build()

        ParaTertButylnitrobenzeneMixture = Material.Builder(15593, SuSyUtility.susyId('para_tert_butylnitrobenzene_mixture'))
                .liquid()
                .components(TertButylbenzene, NitricAcid)
                .colorAverage()
                .build()

        ParaTertButylaniline = Material.Builder(15594, SuSyUtility.susyId('para_tert_butylaniline'))
                .liquid()
                .components(Carbon * 10, Hydrogen * 15, Nitrogen)
                .colorAverage()
                .build()
        ParaTertButylaniline.setFormula("C10H15N")

        ParaTertbutyliodobenzeneSolution = Material.Builder(15595, SuSyUtility.susyId('para_tertbutyliodobenzene_solution'))
                .liquid()
                .components(ParaTertButylaniline, PotassiumIodide, SodiumNitrite, HydrochloricAcid)
                .colorAverage()
                .build()

        MetaChloroperoxybenzoicAcid = Material.Builder(15596, SuSyUtility.susyId('meta_chloroperoxybenzoic_acid'))
                .dust()
                .components(Carbon * 7, Hydrogen * 5, Chlorine, Oxygen * 3)
                .colorAverage()
                .build()
        MetaChloroperoxybenzoicAcid.setFormula("C7H5ClO3")

        AlphaBromoGammaButyrolactone = Material.Builder(15597, SuSyUtility.susyId('alpha_bromo_gamma_butyrolactone'))
                .liquid()
                .components(Carbon * 4, Hydrogen * 5, Bromine, Oxygen * 2)
                .colorAverage()
                .build()
        AlphaBromoGammaButyrolactone.setFormula("C4H5BrO2")
        
        AllylAlcoholSolution = Material.Builder(15598, SuSyUtility.susyId('allyl_alcohol_solution'))
                .liquid()
                .components(Carbon * 3, Hydrogen * 6, Oxygen, Water * 10)
                .colorAverage()
                .build()

        BisSodiumSulfopropylDisulfide = Material.Builder(15599, SuSyUtility.susyId('bis_sodium_sulfopropyl_disulfide'))
                .dust()
        ...
        BisSulfopropylDisulfideSolution = Material.Builder(15600, SuSyUtility.susyId(''))
                .liquid()
                .components(BisSodiumSulfopropylDisulfide, Water)
                .colorAverage()
                .build()

        PropaneOneThreeSultone = Material.Builder(15601, SuSyUtility.susyId('propane_one_three_sultone'))
                .dust()
        ...
        PropaneOneThreeSultoneSolution = Material.Builder(15602, SuSyUtility.susyId('propane_one_three_sultone_solution'))
                .liquid()
                .components(PropaneOneThreeSultone, Water)
                .colorAverage()
                .build()

        DiFourTertButylphenyliodoniumNonaflate = Material.Builder(15603, SuSyUtility.susyId('di_four_tert_butylphenyliodonium_nonaflate'))
                .dust()
        ...
        FluorinatedSulfolaneMixture = Material.Builder(15604, SuSyUtility.susyId('fluorinated_sulfolane_mixture'))
                .liquid()
                .components(Sulfolane, Fluorine)
                .colorAverage()
                .build()

        Hexamethoxymethylmelamine = Material.Builder(15605, SuSyUtility.susyId('hexamethoxymethylamine'))
                .dust()
        ...
        KRF_BARC = Material.Builder(15606, SuSyUtility.susyId('krf_barc'))
                .liquid()
                .components(StyreneAnthracenylMaleimide, TripropylamineTriflate, Hexamethoxymethylmelamine, propylene_glycol_methyl_ether_acetate)
                .colorAverage()
                .build()

        Melamine = Material.Builder(15607, SuSyUtility.susyId('melamine'))
                .dust()
        ...
        ParaAminobenzaldehydeSolution = Material.Builder(15608, SuSyUtility.susyId('para_aminobenzaldehyde_solution'))
                .liquid()
                .components(ParaAminobenzaldehyde, Water)
                .colorAverage()
                .build()
        
        PerfluorobutanesulfonylFluoride = Material.Builder(15609, SuSyUtility.susyId('perfluorobutanesulfonyl_fluoride'))
                .liquid()
                .components(Carbon * 4, Fluorine * 10, Oxygen * 2, Sulfur)
                .colorAverage()
                .build()
        PerfluorobutanesulfonylFluoride.setFormula("C4F10O2S")

        TrimethylsilylChloride = Material.Builder(15610, SuSyUtility.susyId('trimethylsilyl_chloride'))
                .liquid()
                .components(Carbon * 3, Hydrogen * 9, Silicon, Chlorine)
                .colorAverage()
                .build()
        TrimethylsilylChloride.setFormula("C3H9SiCl")

        TwoMethylTwoAdamantanolSolution = Material.Builder(15611, SuSyUtility.susyId('two_methyl_two_adamantanol_solution'))
                .liquid()
                .components(TwoMethylTwoAdamantanol * 5, MagnesiumChlorideSolution * 2, Tetrahydrofuran * 3)
                .colorAverage()
                .build()

        TwoMethylTwoAdamantylMethacrylate = Material.Builder(15612, SuSyUtility.susyId('two_methyl_two_adamantyl_methacrylate'))
                .liquid()
                .components(Carbon * 15, Hydrogen * 22, Oxygen * 2)
                .colorAverage()
                .build()
        TwoMethylTwoAdamantylMethacrylate.setFormula("C15H22O2")

        TwoAminoanthraquinone = Material.Builder(15614, SuSyUtility.susyId('two_aminoanthraquinone'))
                .dust()
