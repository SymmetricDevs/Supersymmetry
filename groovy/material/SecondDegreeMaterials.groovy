...
public class SecondDegreeMaterials {
    public static void register() {
        ...
        SodiumPhosphateSolution = new Material.Builder(13097, SuSyUtility.susyId("sodium_phosphate_solution"))
                .fluid()
                .components(SodiumPhosphate, 1, Water, 1)
                .colorAverage()
                .build();

        DilutedSodiumPhosphateSolution = new Material.Builder(13098, SuSyUtility.susyId("diluted_sodium_phosphate_solution"))
                .fluid()
