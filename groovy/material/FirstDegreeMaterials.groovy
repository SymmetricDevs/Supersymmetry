...
public class FirstDegreeMaterials{
    ...
    public static void register() {
        ...
        CrudeGalliumTrichloride = new Material.Builder(8269, 'crude_gallium_trichloride')
                .dust().fluid()
        ...
        GalliumTrichloride = new Material.Builder(8270, 'gallium_trichloride')
                .fluid()
                .components(Gallium, 1, Chlorine, 3)
                .fluidTemp(351)
                .colorAverage()
        ...
        MercuryIIChloride = new Material.Builder(8271, 'mercury_ii_chloride')
                .dust()
                .components(Mercury, 1, Chlorine, 2)
                .colorAverage()
                .build()

        BoronNitride = new Material.Builder(8272, 'boron_nitride')
                .dust()
                .components(Boron, 1, Nitrogen, 1)
                .colorAverage()
                .build()

        CrudeGalliumArsenide = new Material.Builder(8273, 'crude_gallium_arsenide')
                .ingot()
