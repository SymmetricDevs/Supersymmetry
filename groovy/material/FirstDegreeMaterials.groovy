...
public class FirstDegreeMaterials{
    ...
    public static void register() {
        ...
        ScandiumOxalate = new Material.Builder(8578, SuSyUtility.susyId("scandium_oxalate"))
                .dust()
        ...
        ScandiumOxide = new Material.Builder(8579, SuSyUtility.susyId("scandium_oxide"))
                .dust()
                .components(Scandium, 2, Oxygen, 3)
                .colorAverage()
                .build()

        ScandiumFluoride = new Material.Builder(8580, SuSyUtility.susyId("scandium_fluoride"))
                .dust()
                .components(Scandium, 1, Fluorine, 3)
                .colorAverage()
                .build()

        SodiumPhosphate = new Material.Builder(8577, SuSyUtility.susyId('sodium_phosphate'))
                .dust()
                .colorAverage()
