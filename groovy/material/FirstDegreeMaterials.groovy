...
public class FirstDegreeMaterials{
    ...
    public static void register() {
        ...
        IronPentacarbonyl = new Material.Builder(8311, 'iron_pentacarbonyl')
                .fluid()
                .components(Iron, 1, Carbon, 5, Oxygen, 5)
                .color(0x8c180d)
                .build()
        ...
        IronTwoThreeOxide = new Material.Builder(8313, 'iron_two_three_oxide')
                .dust()
                .color(0x141313)
                .components(Iron, 3, Oxygen, 4)
                .build()

        PurifiedIronTwoThreeOxide = new Material.Builder(8314, 'purified_iron_two_three_oxide')
                .dust()
                .iconSet(SHINY)
                .color(0x141313)
                .components(Iron, 3, Oxygen, 4)
        ...
        PurifiedIronIIIOxide = new Material.Builder(8315, 'purified_iron_iii_oxide')
                .dust()
                .iconSet(SHINY)
                .color(0x8F0C03)
                .components(Iron, 2, Oxygen, 3)
        ...
        NickelIIOxide = new Material.Builder(8316, 'nickel_ii_oxide')
                .dust()
                .color(0x92a371)
                .components(Nickel, 1, Oxygen, 1)
                .build()

        CarbonTetrafluoride = new Material.Builder(8317, 'carbon_tetrafluoride')
                .fluid(FluidTypes.GAS).plasma()
                .components(Carbon, 1, Fluorine, 4)
                .colorAverage()
                .build()

        NitrogenTrifluoride = new Material.Builder(8318, 'nitrogen_trifluoride')
                .fluid(FluidTypes.GAS).plasma()
                .components(Nitrogen, 1, Chlorine, 3)
                .colorAverage()
                .build()

        CobaltFerrite = new Material.Builder(8319, 'cobalt_ferrite')
                .ingot()
        ...
        StrontiumFerrite = new Material.Builder(8320, 'strontium_ferrite')
                .ingot()
                .flags(GENERATE_ROD, GENERATE_RING)
        ...
        BariumFerrite = new Material.Builder(8321, 'barium_ferrite')
                .ingot()
                .flags(GENERATE_ROD, GENERATE_RING)
        ...
        ManganeseZincFerrite = new Material.Builder(8322, 'manganese_zinc_ferrite')
                .ingot()
                .flags(GENERATE_ROD, GENERATE_RING)
        ...
        StrontiumCarbonate = new Material.Builder(8323, 'strontium_carbonate')
                .dust()
                .components(Strontium, 1, Carbon, 1, Oxygen, 3)
                .colorAverage()
                .build()

        BariumCarbonate = new Material.Builder(8324, 'barium_carbonate')
                .dust()
                .components(Barium, 1, Carbon, 1, Oxygen, 3)
                .colorAverage()
                .build()

        LeadOxide = new Material.Builder(8325, 'lead_oxide')
                .dust()
                .components(Lead, 1, Oxygen, 1)
                .colorAverage()
                .build()

        TantalumNitride = new Material.Builder(8326, 'tantalum_nitride')
                .dust()
                .components(Tantalum, 1, Nitrogen, 1)
                .colorAverage()
                .build()

        RutheniumIVOxide = new Material.Builder(8327, 'ruthenium_iv_oxide')
                .dust()
                .components(Ruthenium, 1, Oxygen, 2)
                .colorAverage()
                .build()

        BismuthIridate = new Material.Builder(8328, 'bismuth_iridate')
                .dust()
                .components(Bismuth, 2, Iridium, 2, Oxygen, 7)
                .colorAverage()
                .build()

        SodiumBismuthate = new Material.Builder(8329, 'sodium_bismuthate')
                .dust()
                .components(Sodium, 1, Bismuth, 1, Oxygen, 3)
                .colorAverage()
                .build()

        BismuthIIIOxide = new Material.Builder(8330, 'bismuth_iii_oxide')
                .dust()
                .components(Bismuth, 2, Oxygen, 3)
                .colorAverage()
                .build()

        ManganeseIINitrate = new Material.Builder(8332, 'manganese_ii_nitrate')
                .dust()
        ...
        PurifiedManganeseDioxide = new Material.Builder(8333, 'purified_manganese_dioxide')
                .dust()
                .iconSet("SHINY")
        ...
        BariumTitanate = new Material.Builder(8334, 'barium_titanate')
                .gem().iconSet(RUBY)
                .components(Barium, 1, Titanium, 1, Oxygen, 3)
                .colorAverage()
                .build()

        HafniumTetrachloride = new Material.Builder(8335, 'hafnium_tetrachloride')
                .fluid()
                .fluidTemp(800)
        ...
        ZirconiumTetrachloride = new Material.Builder(8336, 'zirconium_tetrachloride')
                .fluid()
                .fluidTemp(800)
        ...
        NickelCarbonyl.setFormula("Ni(CO)4", true)
              ...
              ChloroaceticAnhydride = new Material.Builder(8349, 'chloroacetic_anhydride')
                .dust()
                .components(Carbon, 4, Hydrogen, 4, Oxygen, 3, Chlorine, 2)
                .colorAverage()
                .build()

        ZirconiumDioxide = new Material.Builder(8350, 'zirconium_dioxide')
                .dust()
                .components(Zirconium, 1, Oxygen, 2)
                .colorAverage()
                .build()

        CopperIINitrate = new Material.Builder(8351, 'copper_ii_nitrate')
                .dust()
                .iconSet(SHINY)
        ...
        NickelIINitrate = new Material.Builder(8352, 'nickel_ii_nitrate')
                .dust()
                .iconSet(SHINY)
        ...
        ZincNitrate = new Material.Builder(8353, 'zinc_nitrate')
                .dust()
                .iconSet(SHINY)
        ...
        MagnesiumNitrate = new Material.Builder(8354, 'magnesium_nitrate')
                .dust()
                .iconSet(SHINY)
        ...
        YttriumOxide = new Material.Builder(8355, 'yttrium_oxide')
                .dust()
                .components(Yttrium, 2, Oxygen, 3)
                .colorAverage()
                .build()

        NeodymiumOxide = new Material.Builder(8356, 'neodymium_oxide')
                .dust()
                .components(Neodymium, 2, Oxygen, 3)
                .colorAverage()
                .build()

        Bromooctane = new Material.Builder(8357, 'bromooctane')
                .fluid()
                .components(Carbon, 8, Hydrogen, 17, Bromine, 1)
                .colorAverage()
                .build()

        LithiumDioctylcopper = new Material.Builder(8358, 'lithium_dioctylcopper')
                .fluid()
                .components(Carbon, 16, Hydrogen, 34, Copper, 1, Lithium, 1)
                .colorAverage()
                .build()

        DecanoylChloride = new Material.Builder(8359, 'decanoyl_chloride')
                .fluid()
                .components(Carbon, 10, Hydrogen, 19, Chlorine, 1, Oxygen, 1)
                .colorAverage()
                .build()

        SodiumCyanoborohydride = new Material.Builder(8360, 'sodium_cyanoborohydride')
                .dust()
        ...
        DilutedSodiumHydroxideSolution = new Material.Builder(8361, "diluted_sodium_hydroxide_solution")
                .fluid()
                .components(Water, 2, SodiumHydroxide, 1)
                .colorAverage()
                .build();

        DiethylEther = new Material.Builder(8362, "diethyl_ether")
                .fluid()
        ...
        Oleum = new Material.Builder(8363, "oleum")
                .fluid()
                .components(SulfuricAcid, 10, SulfurTrioxide, 1)
                .color(0xe8c3a5)
                .build();

        ChromiumSulfateSolution = new Material.Builder(8364, "chromium_sulfate_solution")
                .fluid()
