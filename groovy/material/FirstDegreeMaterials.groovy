...
public class FirstDegreeMaterials {
    ...
    public static void register() {
        ...
        NickelOxideHydroxide = new Material.Builder(8292, SuSyUtility.susyId('nickel_oxide_hydroxide'))
                .dust()
                .components(Nickel, Oxygen * 2, Hydrogen * 1)
                .colorAverage()
                .build();

        NickelOxideHydroxide.setFormula("NiO(OH)", true)
        ...
        AnhydrousCadmiumNitrate = new Material.Builder(8638, SuSyUtility.susyId('anhydrous_cadmium_nitrate'))
                .dust()
        ...
        RawCadmiumHydroxide = new Material.Builder(8640, SuSyUtility.susyId('raw_cadmium_hydroxide'))
                .dust()
