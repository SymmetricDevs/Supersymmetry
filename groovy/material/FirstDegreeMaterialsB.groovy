...
class FirstDegreeMaterialsB {
    static void register() {
        ...
        SodiumAzide = new Material.Builder(8773, SuSyUtility.susyId('sodium_azide'))
                .dust()
        ...
        PhosphorizedCopper = new Material.Builder(8774, SuSyUtility.susyId('phosphorized_copper'))
