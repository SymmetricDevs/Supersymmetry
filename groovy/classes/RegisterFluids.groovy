...
class RegisterFluids {
        ...
        public static void init() {
                ...
                Material HeavyWater = new Material.Builder(12113, "heavy_water")
                        .fluid()
                        .components(Deuterium, 2, Oxygen, 1)
                        .color(0x2c37b0)
                        .build();

                Material HeavyHydrogenSulfide = new Material.Builder(12114, "heavy_hydrogen_sulfide")
                        .fluid()
                        .components(Deuterium, 2, Sulfur, 1)
                        .color(0xb09a2c)
                        .build();

                Material SemiHeavyHydrogenSulfide = new Material.Builder(12118, "semiheavy_hydrogen_sulfide")
                        .fluid(FluidTypes.GAS)
                        .components(Hydrogen, 1, Deuterium, 1, Sulfur, 1)
                        .color(0xc29836)
                        .build();

                Material SemiHeavyWater = new Material.Builder(12119, "semiheavy_water")
                        .fluid()
                        .components(Hydrogen, 1, Deuterium, 1, Oxygen, 1)
                        .color(0x364ec2)
                        .build();

                new Material.Builder(12115, "impure_semiheavy_water")
                        .fluid()
                        .components(Water, 1, SemiHeavyWater, 1)
                        .colorAverage()
                        .build();

                new Material.Builder(12116, "isotopically_pure_hydrogen_sulfide")
                        .fluid(FluidTypes.GAS)
                        .components(HydrogenSulfide, 1)
                        .color(0xffab66)
                        .build();

                new Material.Builder(12117, "impure_semiheavy_hydrogen_sulfide")
                        .fluid(FluidTypes.GAS)
                        .components(HydrogenSulfide, 1, SemiHeavyHydrogenSulfide, 1)
                        .colorAverage()
                        .build();

                new Material.Builder(12120, "impure_heavy_hydrogen_sulfide")
                        .fluid(FluidTypes.GAS)
                        .components(HydrogenSulfide, 1, HeavyHydrogenSulfide, 1)
                        .colorAverage()
                        .build();

                new Material.Builder(12121, "sea_water")
                        .fluid()
