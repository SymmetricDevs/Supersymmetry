...
private void generateHighPressureGases(Material materialName, int id){
...
private void generateThermoRefrigerant(Material materialName, int id){
    var color = materialName.getMaterialRGB();
...
private void generateCoolant(Material materialName, int id){
...
eventManager.listen {
    GregTechAPI.MaterialEvent event ->
        ...
        println("Running RegisterFluids.groovy...")
