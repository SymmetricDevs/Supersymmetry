...
eventManager.listen { PostMaterialEvent event ->
    ...
    new StandardMetaItem(2 as short).with {
        ...
        addItem(2847, "component.thin_film_resistor.wafer.patterned")
        addItem(2848, "component.thin_film_resistor.wafer.deposited")
        addITem(2849, "component.thin_film_resistor.wafer.unetched")
        addItem(2848, "component.thin_film_resistor.wafer.etched")
        addItem(2849, "component.thin_film_resistor.unterminated")
        addItem(2850, "component.thin_film_resistor.polished")
        addItem(2851, "component.thin_film_resistor.dipped")
        addItem(2852, "component.thin_film_resistor.terminated")
        addItem(2853, "component.thin_film_resistor.plated")
        addItem(2854, "component.thin_film_resistor.soldered")
        addItem(2855, "component.thin_film_resistor")
