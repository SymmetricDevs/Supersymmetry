...
eventManager.listen { PostMaterialEvent event ->
    ...
    new StandardMetaItem(2 as short).with {
        ...
        addItem(8064, "wafer.thyristor.step_one.coated")
        addItem(8065, "wafer.thyristor.step_one.exposed")
        addItem(8066, "wafer.thyristor.step_four.coated")
        addItem(8067, "wafer.thyristor.step_four.exposed")
        addItem(8068, "wafer.thyristor.step_eight.coated")
        addItem(8069, "wafer.thyristor.step_eight.exposed")
