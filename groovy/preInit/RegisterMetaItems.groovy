...
eventManager.listen { PostMaterialEvent event ->
    ...
    new StandardMetaItem(2 as short).with {
        ...
        addItem(2850, "component.thin_film_resistor.wafer.deposited")
        addItem(2851, "component.thin_film_resistor.wafer.unetched")
        addItem(2852, "component.thin_film_resistor.wafer.etched")
        addItem(2853, "component.thin_film_resistor.unterminated")
        addItem(2854, "component.thin_film_resistor.polished")
        addItem(2855, "component.thin_film_resistor.dipped")
        addItem(2856, "component.thin_film_resistor.terminated")
        addItem(2857, "component.thin_film_resistor.plated")
        addItem(2858, "component.thin_film_resistor.soldered")
        addItem(2859, "component.thin_film_resistor")
