...
eventManager.listen { PostMaterialEvent event ->
    ...
    new StandardMetaItem(2 as short).with {
        ...
        addItem(2809, "sheet.doped_barium_titanate")
        addItem(2810, "component.bme_cap.layer")
        addItem(2811, "component.bme_cap.wafer")
        addItem(2812, "component.bme_cap.unfired")
        addItem(2813, "component.bme_cap.fired")
        addItem(2814, "component.bme_cap.polished")
        addItem(2815, "component.bme_cap.dipped")
        addItem(2816, "component.bme_cap.terminated")
        addItem(2817, "component.bme_cap.plated")
        addItem(2818, "component.bme_cap")
        addItem(2819, "component.pme_cap.layer")
        addItem(2820, "component.pme_cap.wafer")
        addItem(2821, "component.pme_cap.unfired")
        addItem(2822, "component.pme_cap.fired")
        addItem(2823, "component.pme_cap.polished")
        addItem(2824, "component.pme_cap.dipped")
        addItem(2825, "component.pme_cap.terminated")
        addItem(2826, "component.pme_cap.plated")
        addItem(2827, "component.pme_cap")
        addItem(2828, "screen_printing.pattern.mlcc")
        addItem(2829, "mesh.stainless_steel")

        addItem(2860, "edlc_electrode_powder")
        addItem(2861, "edlc_electrode_coated")
        addItem(2862, "edlc_electrode")
        addItem(2863, "component.capacitor.edlc")
        addItem(2864, "component.thyristor.assembly")
        addItem(2865, "component.thyristor")
