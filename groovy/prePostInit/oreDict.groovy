...
oreDict.add('dustLithium', metaitem('dustHighPurityLithium'))
oreDict.add('dustBeryllium', metaitem('dustHighPurityBeryllium'))
oreDict.add('dustBoron', metaitem('dustHighPurityBoron'))
oreDict.add('dustCarbon', metaitem('dustHighPurityCarbon'))
oreDict.add('dustSodium', metaitem('dustHighPuritySodium'))
oreDict.add('dustMagnesium', metaitem('dustHighPurityMagnesium'))
oreDict.add('dustAluminium', metaitem('dustHighPurityAluminium'))
oreDict.add('dustSilicon', metaitem('dustHighPuritySilicon'))
oreDict.add('dustPhosphorus', metaitem('dustHighPurityPhosphorus'))
oreDict.add('dustSulfur', metaitem('dustHighPuritySulfur'))
oreDict.add('dustPotassium', metaitem('dustHighPurityPotassium'))
oreDict.add('dustCalcium', metaitem('dustHighPurityCalcium'))
oreDict.add('dustScandium', metaitem('dustHighPurityScandium'))
oreDict.add('dustTitanium', metaitem('dustHighPurityTitanium'))
oreDict.add('dustVanadium', metaitem('dustHighPurityVanadium'))
oreDict.add('dustChrome', metaitem('dustHighPurityChrome'))
oreDict.add('dustManganese', metaitem('dustHighPurityManganese'))
oreDict.add('dustIron', metaitem('dustHighPurityIron'))
oreDict.add('dustCobalt', metaitem('dustHighPurityCobalt'))
oreDict.add('dustNickel', metaitem('dustHighPurityNickel'))
oreDict.add('dustCopper', metaitem('dustHighPurityCopper'))
oreDict.add('dustZinc', metaitem('dustHighPurityZinc'))
oreDict.add('dustGallium', metaitem('dustHighPurityGallium'))
oreDict.add('dustGermanium', metaitem('dustHighPurityGermanium'))
oreDict.add('dustArsenic', metaitem('dustHighPurityArsenic'))
oreDict.add('dustSelenium', metaitem('dustHighPuritySelenium'))
oreDict.add('dustRubidium', metaitem('dustHighPurityRubidium'))
oreDict.add('dustStrontium', metaitem('dustHighPurityStrontium'))
oreDict.add('dustYttrium', metaitem('dustHighPurityYttrium'))
oreDict.add('dustZirconium', metaitem('dustHighPurityZirconium'))
oreDict.add('dustNiobium', metaitem('dustHighPurityNiobium'))
oreDict.add('dustMolybdenum', metaitem('dustHighPurityMolybdenum'))
oreDict.add('dustTechnetium', metaitem('dustHighPurityTechnetium'))
oreDict.add('dustRhenium', metaitem('dustHighPurityRhenium'))
oreDict.add('dustRhodium', metaitem('dustHighPurityRhodium'))
oreDict.add('dustPalladium', metaitem('dustHighPurityPalladium'))
oreDict.add('dustSilver', metaitem('dustHighPuritySilver'))
oreDict.add('dustCadmium', metaitem('dustHighPurityCadmium'))
oreDict.add('dustIndium', metaitem('dustHighPurityIndium'))
oreDict.add('dustTin', metaitem('dustHighPurityTin'))
oreDict.add('dustAntimony', metaitem('dustHighPurityAntimony'))
oreDict.add('dustTellurium', metaitem('dustHighPurityTellurium'))
oreDict.add('dustIodine', metaitem('dustHighPurityIodine'))
oreDict.add('dustCaesium', metaitem('dustHighPurityCaesium'))
oreDict.add('dustBarium', metaitem('dustHighPurityBarium'))
oreDict.add('dustLanthanum', metaitem('dustHighPurityLanthanum'))
oreDict.add('dustHafnium', metaitem('dustHighPurityHafnium'))
oreDict.add('dustTantalum', metaitem('dustHighPurityTantalum'))
oreDict.add('dustTungsten', metaitem('dustHighPurityTungsten'))
oreDict.add('dustRhenium', metaitem('dustHighPurityRhenium'))
oreDict.add('dustOsmium', metaitem('dustHighPurityOsmium'))
oreDict.add('dustIridium', metaitem('dustHighPurityIridium'))
oreDict.add('dustPlatinum', metaitem('dustHighPurityPlatinum'))
oreDict.add('dustGold', metaitem('dustHighPurityGold'))
oreDict.add('dustThallium', metaitem('dustHighPurityThallium'))
oreDict.add('dustLead', metaitem('dustHighPurityLead'))
oreDict.add('dustBismuth', metaitem('dustHighPurityBismuth'))
oreDict.add('dustCerium', metaitem('dustHighPurityCerium'))
oreDict.add('dustPraseodymium', metaitem('dustHighPurityPraseodymium'))
oreDict.add('dustNeodymium', metaitem('dustHighPurityNeodymium'))
oreDict.add('dustSamarium', metaitem('dustHighPuritySamarium'))
oreDict.add('dustEuropium', metaitem('dustHighPurityEuropium'))
oreDict.add('dustGadolinium', metaitem('dustHighPurityGadolinium'))
oreDict.add('dustTerbium', metaitem('dustHighPurityTerbium'))
oreDict.add('dustDysprosium', metaitem('dustHighPurityDysprosium'))
oreDict.add('dustHolmium', metaitem('dustHighPurityHolmium'))
oreDict.add('dustErbium', metaitem('dustHighPurityErbium'))
oreDict.add('dustThulium', metaitem('dustHighPurityThulium'))
oreDict.add('dustYtterbium', metaitem('dustHighPurityYtterbium'))
oreDict.add('dustLutetium', metaitem('dustHighPurityLutetium'))
oreDict.add('dustThorium', metaitem('dustHighPurityThorium'))
