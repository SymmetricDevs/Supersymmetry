...
class Etching {
    ...
    public static final etchants = [ //FIXME: Replace all RIE etchants with proper mixtures
        aluminium: [
            ...
            new Etchant(["chlorine" : 55, "boron_trichloride" : 25, "nitrogen" : 20], ["corrosive_gas" : 100], EV, 1.67, true, true),
            new Etchant("aluminium_etchant", "acidic_wastewater", MV, 50, 0.125, false, false),
        ],
        gallium_arsenide: [
            ...
            new Etchant("ultrapure_hydrogen_peroxide_solution", "wastewater", MV, 50, 0.125, false, false),
        ],
        silicon: [
            ...
            new Etchant(["hydrogen_bromide" : 50, "chlorine" : 30, "helium" : 15, "oxygen" : 5], ["corrosive_gas" : 100], EV, 1.67, true, true),
            new Etchant("tetramethylammonium_hydroxide_solution", "wastewater", MV, 40, 0.4, true, false),
            new Etchant("ultrapure_hydrofluoric_acid", "acidic_wastewater", MV, 40, 0.2, false, false)
        ],
        silicon_dioxide: [
            ...
            new Etchant(["fluoroform" : 35, "carbon_tetrafluoride" : 15, "argon" : 50], ["corrosive_gas" : 100], EV, 1.67, true, true),
            new Etchant("buffered_oxide_etchant", "acidic_wastewater", MV, 40, 0.4, false, false),
        ],
        silicon_nitride: [
            ...
            new Etchant(["fluoroform" : 20, "oxygen" : 60, "helium" : 20], ["corrosive_gas" : 100], EV, 1.67, true, true),
            new Etchant("phosphoric_acid", "acidic_wastewater", MV, 40, 0.4, false, false),
        ],
        titanium: [
            //new Etchant("plasma.boron_trichloride", EV, 10, 0.0167, true, true),
            new Etchant("ultrapure_hydrofluoric_acid", "acidic_wastewater", MV, 40, 0.4, false, false),
        ],
        nickel: [
            //new Etchant("plasma.boron_trichloride", EV, 10, 0.0167, true, true),
            new Etchant("ultrapure_hydrofluoric_acid", "acidic_wastewater", MV, 40, 0.4, false, false),
        ...
        tungsten: [
            //new Etchant("plasma.carbon_tetrafluoride", EV, 10, 0.0167, true, true),
            new Etchant("hydrogen_peroxide_solution", "wastewater", MV, 40, 0.4, false, false),
        ],
        copper: [
            ...
            new Etchant("ultrapure_iron_iii_chloride_solution", "acidic_wastewater", MV, 100, 1, false, false),
            new Etchant("sodium_bisulfate_solution", "wastewater", MV, 100, 1, false, false),
        ],
        indium_tin_oxide: [
            new Etchant("nitration_mixture", "acidic_wastewater", MV, 50, 0.4, false, false),
        ],
        chrome: [
            new Etchant("hydrochloric_acid", "acidic_wastewater", MV, 50, 0.4, false, false),
        ],
        gold: [
            new Etchant("aqua_regia", "acidic_wastewater", MV, 50, 0.4, false, false),
        ],
        platinum: [
            new Etchant("aqua_regia", "acidic_wastewater", MV, 50, 0.2, false, false),
        ],
        titanium_nitride: [
            new Etchant("nitric_acid", "acidic_wastewater", MV, 50, 0.2, false, false),
            new Etchant("ultrapure_hydrofluoric_acid", "acidic_wastewater", MV, 50, 0.4, false, false),
        ],
        hafnium_dioxide: [
            ...
            new Etchant(["boron_trichloride" : 60, "chlorine" : 20, "argon" : 20], ["corrosive_gas" : 100], EV, 0.8, true, true),
        ],
        nickel_silicide: [
            new Etchant("phosphoric_acid", "acidic_wastewater", HV, 50, 1, false, false)
        ],
        cobalt_silicide: [
            ...
            new Etchant("nitration_mixture", "acidic_wastewater", HV, 50, 1, false, false)
        ],
        silicon_bosch: [
            new Etchant(["sulfur_hexafluoride" : 50, "octafluorocyclobutane" : 30, "argon" : 20], ["corrosive_gas" : 100], EV, 40, true, true)
        ],
        zirconia: [
        ...
        borophosphosilicate_glass: [
            new Etchant(["octafluorocyclobutane" : 25, "carbon_tetrafluoride" : 20, "oxygen" : 10, "argon" : 45], ["corrosive_gas" : 100], EV, 1.67, true, true)
        ],
        silicon_oxycarbide_hydride: [
            new Etchant(["octafluorocyclobutane" : 15, "argon" : 80, "oxygen" : 5], ["corrosive_gas" : 100], EV, 1.67, true, true)
        ],
        silicon_oxynitride: [
            new Etchant(["carbon_tetrafluoride" : 30, "fluoroform" : 20, "argon" : 50], ["corrosive_gas" : 100], EV, 1.67, true, true)
        ],
        silicon_silica_coetch: [
            new Etchant(["hexafluorobutadiene" : 15, "carbon_tetrafluoride" : 25, "argon" : 50, "oxygen" : 10], ["corrosive_gas" : 100], EV, 0.4, true, true)
        ],
        silicon_nitride_silica_coetch: [
            new Etchant(["hexafluorobutyne" : 15, "carbon_tetrafluoride" : 25, "argon" : 50, "oxygen" : 10], ["corrosive_gas" : 100], EV, 0.4, true, true)
        ],
        nichrome: [
            new Etchant("ultrapure_iron_iii_chloride_solution", "acidic_wastewater", MV, 100, 1, false, false)
        ],
