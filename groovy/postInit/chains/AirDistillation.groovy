...
//CONDENSATION
BATH_CONDENSER.recipeBuilder()
    .fluidInputs(fluid('subcooled_oxygen_rich_liquid') * 50)
    .fluidInputs(fluid('crude_argon_vapor') * 120)
    .fluidOutputs(fluid('liquid_crude_argon') * )
...
FBR.recipeBuilder()
    .fluidInputs(fluid('liquid_crude_argon') * 100)
    .fluidInputs(fluid('hydrogen') * 48)
    .notConsumable(metaitem('catalystBedDeoxygenationCatalyst'))
    .chancedOutput(metaitem('dustIce'), 240, 0)
    .fluidOutputs(fluid('liquid_deoxygenated_argon') * 100)
    .duration(100)
    .EUt(Globals.voltAmps[3])
    .buildAndRegister()
