...
SIFTER.recipeBuilder()
    ...
    .fluidInputs(fluid('chilled_air') * 11000)
    .fluidOutputs(fluid('purified_air') * 11000)
...
VACUUM_CHAMBER.recipeBuilder()
    ...
    .fluidOutputs(fluid('carbon_dioxide') * 11)
    .duration(100)
    .EUt(Globals.voltAmps[1])
    .buildAndRegister()
...
HEAT_EXCHANGER.recipeBuilder()
    .fluidInputs(fluid('untreated_liquid_nitrogen') * 25)
    .fluidInputs(fluid('untreated_liquid_oxygen') * 25)
    .fluidOutputs(fluid('subcooled_liquid_nitrogen') * 25)
    .fluidOutputs(fluid('liquid_oxygen_product') * 25)
    .duration(5)
    .buildAndRegister()
...
//WASTE GAN PURIFICATION
SIFTER.recipeBuilder()
    .notConsumable(ore('dustTinyMolecularSieve'))
...
BATH_CONDENSER.recipeBuilder()
    ...
    .fluidOutputs(fluid('liquid_waste_nitrogen'))
    .cleanroom(CleanroomType.SINGLE_COLUMN_CRYOGENIC_DISTILLATION_PLANT)
    .duration(2)
    .buildAndRegister()
...
//ADAPTED LOW PRESSRE RECIPE
LOW_PRESSURE_DISTILLATION_TOWER.recipeBuilder()
    .circuitMeta(3)
    .fluidInputs(fluid('oxygen_rich_liquid') * 100)
    .fluidInputs(fluid('lp_oxygen_rich_gas') * 1600)
    .fluidInputs(fluid('lp_nitrogen_rich_gas') * 6400)
