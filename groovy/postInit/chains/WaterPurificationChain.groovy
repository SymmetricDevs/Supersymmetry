...
EVAPORATION_POOL.recipeBuilder()
        ...
        .outputs(metaitem('dustBrineEvaporite') * 80)
        .duration(150)
        .EUt(120)
        .buildAndRegister()
...
EVAPORATION_POOL.recipeBuilder()
        ...
        .fluidInputs(fluid('brine') * 10000)
        .outputs(metaitem('dustBrineEvaporite') * 80)
        .fluidOutputs(fluid('concentrated_brine') * 250)
        .duration(150)
        .EUt(120)
        .buildAndRegister()

SIFTER.recipeBuilder()
        .inputs(metaitem('dustBrineEvaporite') * 5)
        .chancedOutput(metaitem('dustSalt') * 2, 8000, 500)
        .chancedOutput(metaitem('dustSalt') * 2, 8000, 500)
        .chancedOutput(metaitem('dustRockSalt') * 2, 5000, 250)
        .chancedOutput(metaitem('dustPotassiumCarbonate') * 6, 3000, 250)
        .duration(20)
        .EUt(30)
        .buildAndRegister();
...
//TODO: ENABLE WASTE WATER WHEN DUMPING WORKS (0.0.13?)
