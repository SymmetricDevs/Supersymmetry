...
FLOTATION.recipeBuilder()
    .inputs(ore('dustFilteredPhosphatePulp'))
    //.notConsumable(fluid('alkaline_sodium_oleate_solution') * 1000) add when lithium chain is complete
    .notConsumable(fluid('fuel_oil') * 100)
    .outputs(metaitem('dustPhosphateConcentrate'))
...
BATCH_REACTOR.recipeBuilder()
    ...
    .outputs(metaitem('dustPhosphogypsum'))
