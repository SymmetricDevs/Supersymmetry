...
//DISSOLUTION
BR.recipeBuilder()
        .inputs(metaitem('dustAlkaliFusedBeryl') * 2)
...
//ALUM SEPARATION
BR.recipeBuilder()
        .inputs(metaitem('dustPotassiumChloride') * 6)
        .fluidInputs(fluid('dissolved_beryl') * 1000)
        .outputs(metaitem('dustPotassiumAlum') * 12)
        .fluidOutput(fluid('impure_beryllium_sulfate_solution') * 1000)
...
BR.recipeBuilder() //Potassium permangante is typically added to oxidize iron II to III, however this may be too demanding for an MV line
        .inputs(metaitem('dustTinyCalcite') * 5)
...
BR.recipeBuilder() //100% (Technically, it makes a little bit of ferric EDTA but I dont want to model it)
        .inputs(metaitem('dustSodiumHydroxide') * 18)
        .inputs(metaitem('dustTinyTetrasodiumEthylenediaminetetraaceticAcid'))
        .fluidInputs(fluid('beryllium_sulfate_solution') * 1000)
        .outputs(metaitem('dustBerylliumHydroxide') * 12)
        .fluidOutputs(fluid('sodium_sulfate_solution') * 8000)
        .EUt(120)
...
CENTRIFUGE.recipeBuilder()
        .inputs(metaitem('dustFluorideFusedBeryl') * 23)
...
REACTION_FURNACE.recipeBuilder()
        .inputs(metaitem('dustEmerald') * 29)
        .inputs(metaitem('dustCarbon') * 18)
        .fluidInputs(fluid('chlorine') * 36000)
        .fluidOutputs(fluid('chlorinated_beryl') * 1000)
        .EUt(Globals.voltAmps[4])
        .duration(480)
        .buildAndRegister()
...
ROASTER.recipeBuilder()
        .inputs(metaitem('dustAmmoniumFluoroberyllate') * 13)
...
BR.recipeBuilder()
        .inputs(fluid('disassociated_ammonium_fluoride') * 1000)
...
REACTION_FURNACE.recipeBuilder()
        .inputs(metaitem('dustBerylliumFluoride') * 3)
...
BR.recipeBuilder()
        .inputs(metaitem('dustMagnesiumFluoride') * 3)
