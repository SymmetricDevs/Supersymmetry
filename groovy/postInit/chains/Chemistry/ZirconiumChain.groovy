...
FF.recipeBuilder()
        ...
        .notConsumable(fluid('sodium_carbonate_solution') * 1000)
...
ADVANCED_ARC_FURNACE.recipeBuilder()
        ...
        .output(metaitem('dustSiliconDioxide') * 3)
        .duration(20)
...
VACUUM_CHAMBER.recipeBuilder()
        ...
        .fluidOutputs(fluid('zirconium_tetrachloride') * 50)
        .duration(300)
...
MACERATOR.recipeBuilder()
        ...
        .chancedOutput(ore('dustZirconium').first(), 8500, 0)
        .duration(100)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
