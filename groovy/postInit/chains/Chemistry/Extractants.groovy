...
DISTILLATION_TOWER.recipeBuilder()
        ...
        .fluidOutputs(fluid('chloroacetic_anhydride') * 1000)
...
BR.recipeBuilder()
        .inputs(metaitem('dustTriethylaluminium') * 11)
        .fluidInputs(fluid('ethylene') * 4500)
        .outputs(metaitem('dustTrialkylaluminium') * 38)
        .duration(400)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()

ROASTER.recipeBuilder()
        .inputs(metaitem('dustTrialkylaluminium') * 64)
        .inputs(metaitem('dustTrialkylaluminium') * 12)
        .fluidInputs(fluid('oxygen') * 3000)
        .outputs(metaitem('dustAluminiumAlkoxide') * 64)
        .outputs(metaitem('dustAluminiumAlkoxide') * 15)
        .duration(500)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()

BR.recipeBuilder()
        .inputs(metaitem('dustAluminiumAlkoxide') * 64)
        .inputs(metaitem('dustAluminiumAlkoxide') * 15)
        .fluidInputs(fluid('water') * 3000)
        .outputs(metaitem('dustAluminiumHydroxide') * 7)
        .fluidOutputs(fluid('n_octanol') * 3000)
        .duration(500)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .fluidInputs(fluid('chloroacetic_anhydride') * 1000)
...
CSTR.recipeBuilder()
        .fluidInputs(fluid('sodium_hydroxide_solution') * 50)
        .fluidInputs(fluid('butyraldehyde') * 100)
        .fluidOutputs(fluid('diluted_two_ethyl_two_hexenal') * 150)
        .duration(3)
        .EUt(120)
        .buildAndRegister()

DISTILLATION_TOWER.recipeBuilder()
        .fluidInputs(fluid('diluted_two_ethyl_two_hexenal') * 1500)
        .fluidOutputs(fluid('two_ethyl_two_hexenal') * 500)
...
LCR.recipeBuilder()
        ...
        .fluidInputs(fluid('capric_acid') * 2000)
...
BR.recipeBuilder()
        ...
        .fluidOutputs(fluid('gilman_reagent') * 1000)
        .duration(160)
        .EUt(120)
        .buildAndRegister()
...
CSTR.recipeBuilder()
        .fluidInputs(fluid('gilman_reagent') * 100)
        .fluidInputs(fluid('decanoyl_chloride') * 100)
        .fluidOutputs(fluid('nine_octadecene') * 150)
        .duration(15)
        .EUt(120)
        .buildAndRegister()

BR.recipeBuilder()
        .fluidInputs(fluid('borane') * 1000)
...
LCR.recipeBuilder()
        ...
        .fluidInputs(fluid('nine_octadecene') * 3000)
