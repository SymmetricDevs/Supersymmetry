...
ROASTER.recipeBuilder()
        ...
        .fluidOutputs(metaitem('aluminium_alkoxide_solution') * 1000)
        .duration(500)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(metaitem('aluminium_alkoxide_solution') * 1000)
...
//C10 & 12 ACIDS
LCR.recipeBuilder()
        .inputs(metaitem('dustChromiumIiiOxide') * 16)
...
CHEMICAL_BATH.recipeBuilder()
        ...
        .outputs(fluid('sulfuric_acid') * 1000)
        .EUt(120)
        .duration(200)
        .buildAndRegister()
