...
FLOTATION.recipeBuilder()
        ...
        .outputs(metaitem('dustSpodumene') * 8)
        .EUt(30)
        .duration(100)
        .buildAndRegister()

ROASTER.recipeBuilder()
        .inputs(metaitem('dustSpodumene') * 3)
        .outputs(metaitem('dustBetaSpodumene') * 2)
        .EUt(30)
        .duration(200)
        .buildAndRegister()

ROASTER.recipeBuilder()
        .inputs(metaitem('dustPetalite') * 3)
        .outputs(metaitem('dustRoastedPetalite') * 3)
        .EUt(30)
        .duration(200)
        .buildAndRegister()
...
FLUIDIZEDBR.recipeBuilder()
        .inputs(metaitem('dustSpodumene') * 3)
        .outputs(metaitem('dustBetaSpodumene') * 3)
        .EUt(120)
        .duration(40)
        .buildAndRegister()

FLUIDIZEDBR.recipeBuilder()
        .inputs(metaitem('dustPetalite') * 4)
        .outputs(metaitem('dustRoastedPetalite') * 6)
        .EUt(160)
        .duration(40)
        .buildAndRegister()

CENTRIFUGE.recipeBuilder()
        .inputs(metaitem('dustRoastedPetalite') * 3)
        .outputs(metaitem('dustBetaSpodumene') * 2)
        .outputs(metaitem('dustSiliconDioxide') * 1)
        .EUt(30)
        .duration(40)
        .buildAndRegister()
...
CENTRIFUGE.recipeBuilder()
        ...
        .fluidOutputs(fluid('lithium_sulfate_solution') * 2000)
...
ROASTER.recipeBuilder()
        ...
        .inputs(metaitem('dustAmblygonite') * 9)
...
BR.recipeBuilder()
        .fluidInputs(fluid('amblygonite_leach') * 1000)
...
for (fuel in sintering_fuels) {
    if (fuel.isPlasma) {
        SINTERING_RECIPES.recipeBuilder()
                ...
                .outputs(metaitem('dustRoastedLepidolite') * 24)
...
CRYSTALLIZER.recipeBuilder()
        .inputs(metaitem('dustRoastedLepidolite') * 12)
        .fluidInputs(fluid('sulfuric_acid') * 1000)
