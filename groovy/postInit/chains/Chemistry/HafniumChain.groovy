...
CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('diluted_sulfuric_acid') * 4000)
        .fluidOutputs(fluid('hafnium_extraction_mixture') * 1000)
        .fluidOutputs(fluid('hafnium_sulfate_solution') * 2000)
...
for (highPurityCombustible in Globals.highPurityCombustibles) {
        FLUIDIZED_BED_REACTOR.recipeBuilder()
                ...
                .duration(10 * highPurityCombustible.duration)
...
for (inertGas in Globals.inertGases) {
        EBF.recipeBuilder()
                .circuitMeta(2)
                .fluidIntputs(fluid('hafnium_tetrachloride') * 720)
                .notConsumable(fluid(inertGas.name) * inertGas.amountRequired)
...
VACUUM_CHAMBER.recipeBuilder()
        ...
        .fluidOutputs(fluid('hafnium_tetrachloride') * 50)
        .duration(300)
...
MACERATOR.recipeBuilder()
        ...
        .chancedOutput(ore('dustHafnium').first(), 8500, 0)
        .duration(100)
