...
//MALACHITE
MIXER.recipeBuilder()
    .inputs(metaitem('dustImpureMalachite') * 8)
...
CSTR.recipeBuilder()
    ...
    .fluidInputs(fluid('hydrogen_peroxide') * 5)
...
DISTILLERY.recipeBuilder()
    .fluidInputs(fluid('diluted_copper_sulfate_solution'))
...
DISTILLATION_TOWER.recipeBuilder()
    ...
    .fluidOutputs(fluid('water') * 2300)
    .EUt(30)
    .duration(100)
    .buildAndRegister()

DISTILLERY.recipeBuilder()
    .fluidInputs(fluid('malachite_leach'))
...
for (copperOre in copperOres) {
    MIXER.recipeBuilder()
        .inputs(metaitem('dustImpure' + copperOre.name) * 8)
...
/*REVERBERATORY_FURNACE.recipeBuilder()
    .inputs(metaitem('dustCopperConcentrate'))
...
REACTION_FURNACE.recipeBuilder()
    .inputs(metaitem('dustCopperMatte'))
    .fluidInputs(fluid('oxygen') * 2000)
    .fluidOutputs(fluid('sulfur_dioxide') * 1000)
    .outputs(metaitem('dustCopperMatteFlueDust'))
...
ELECTROLYTIC_CELL.recipeBuilder()
    ...
    .chancedOutput(metaitem('copper_anode_slime'), 1000, 0)
...
CENTRIFUGE.recipeBuilder()
    .inputs(metaitem('dustCopperMatteFlueDust'))
