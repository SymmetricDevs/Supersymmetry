...
MIXER.recipeBuilder()
    .inputs(metaitem('dustRawElectrum') * 2)
...
BATCH_REACTOR.recipeBuilder()
    .inputs(metaitem('dustRawElectrum') * 3)
    .fluidInputs(fluid('nitric_acid') * 4000)
    .fluidInputs(fluid('distilled_water') * 2000)
    .outputs(metaitem('dustGold') * 2)
    .fluidOutputs(fluid('silver_nitrate_solution') * 4000)
...
CHEMICAL_BATH.recipeBuilder()
    .inputs(metaitem('dustLoadedCarbon'))
...
BATCH_REACTOR.recipeBuilder()
    .inputs(metaitem('wireFineGoldPlatedSteel') * 24)
