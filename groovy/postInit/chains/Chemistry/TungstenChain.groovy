...
ROASTER.recipeBuilder()
        ...
        .outputs(ore('dustCalcinedScheelite'))
        .duration(20)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
...
FF.recipeBuilder()
        ...
        .notConsumable(ore('dustSodiumSilicate') * 6)
        .fluidOutputs(fluid('scheelite_slurry') * 1000)
        .fluidOutputs(fluid('granite_wolframite_slurry') * 1000)
        .EUt(Globals.voltAmps[3])
        .duration(80)
        .buildAndRegister()
...
LCR.recipeBuilder()
        ...
        .fluidInputs(fluid('distilled_water') * 2000)
        .chancedOutput(ore('dustMolybdenumTrisulfide') * 4, 5000, 0)
...
CENTRIFUGE.recipeBuilder()
        ...
        .fluidInputs(fluid('tungsten_extraction_mixture') * 8000) 
        .fluidOutputs(fluid('diluted_sodium_sulfate_solution') * 11250) // 45/4x H2O, 5/4x Na2SO4 (9:1)
        .fluidOutputs(fluid('tungsten_extract') * 8000)
        .EUt(Globals.voltAmps[4])
        .duration(120)
        .buildAndRegister()
...
CENTRIFUGE.recipeBuilder()
        .fluidInputs(fluid('molybdenum_free_tungstate_solution') * 16875)
        .fluidInputs(fluid('tungsten_extraction_mixture') * 8000) 
        .fluidOutputs(fluid('diluted_sodium_sulfate_solution') * 16875)
        .fluidOutputs(fluid('tungsten_extract') * 8000) // Extracts 6 moles of tungsten as trioctylammonium isopolytungstate (R3NH)5(HW6O21)
        .EUt(Globals.voltAmps[4])
        .duration(180)
        .buildAndRegister()
