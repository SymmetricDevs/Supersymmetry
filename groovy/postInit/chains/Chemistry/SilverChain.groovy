...
ROASTER.recipeBuilder()
    ...
    .outputs(ore('dustSmallSilverOxide').first() * 9)
...
ROASTER.recipeBuilder()
    .inputs(ore('dustTinyAcanthite') * 4)
    .inputs(ore('dustTinyCalcite'))
    .fluidInputs(fluid('air') * 6400)
    .outputs(ore('dustSmallSilverOxide').first() * 6)
    .fluidOutputs(fluid('sulfur_dioxide') * 667)
    .duration(240)
    .EUt(Globals.voltAmps[1])
    .buildAndRegister()
