...
CSTR.recipeBuilder()
.fluidInputs(fluid('caprylic_acid') * 50)
.fluidInputs(fluid('thionyl_chloride') * 50)
.fluidOutputs(fluid('octanoyl_chloride') * 50)
.fluidOutputs(fluid('hydrogen_chloride') * 50)
...
BR.recipeBuilder()
.fluidInputs(fluid('octanoyl_chloride') * 50)
.fluidInputs(fluid('hydrofluoric_acid') * 750)
.fluidOutputs(fluid('fluorinated_octanoyl_chloride_mixture') * 50)
...
.outputs(metaitem('dustPerfluoroocanoicAcid' * 26))
...
MIXER.recipeBuilder()
.fluidInputs(fluid('water') * 1000)
.fluidInputs(fluid('perfluorooctanoic_acid') * 26)
.fluidOutputs(fluid('fluorinated_detergent_mixture') * 1000)
.duration(200)
.EUt(30)
.buildAndRegister()
...
.fluidInputs(fluid('fluorinated_detergent_mixture') * 1000)
