...
.fluidOutputs(fluid('dilute_ammonium_sulfate_solution') * 2000)
.duration(160)
.EUt(30)
.buildAndRegister()

DISTILLERY.recipeBuilder()
.fluidInputs(fluid('dilute_ammonium_sulfate_solution') * 2000)
...
ROASTER.recipeBuilder()
        .inputs(metaitem('dustSodiumNitrite') * 8)
...
ROASTER.recipeBuilder()
        ...
        .inputs(metaitem('dustSodiumAmide') * 4)
        .fluidOutputs(fluid('hydrogen') * 2000)
...
BR.recipeBuilder()
        .fluidInputs(fluid('hydrochloric_acid') * 1000)
        .inputs(metaitem('dustSodiumCyanide') * 3)
...
SINTERING_OVEN.recipeBuilder()
        .inputs(metaitem('dustAluminiumNitride') * 10)
        .inputs(metaitem('dustAlumina') * 45)
...
BR.recipeBuilder()
        .inputs(metaitem('dustZirconiumTetrachlorideTetrahydrofuran') * 7)
        .inputs(metaitem('dustSodiumCyclopentadienide') * 2)
        .outputs(metaitem('dustZirconoceneDichloride'))
        .outputs(metaitem('dustSodiumChloride') * 4)
...
BR.recipeBuilder()
        .inputs(metaitem('dustZirconiumOxide') * 6)
        .inputs(metaitem('dustMethylaluminoxane'))
        .inputs(metaitem('dustZirconoceneDichloride'))
