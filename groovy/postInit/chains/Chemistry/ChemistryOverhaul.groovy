...
ROASTER.recipeBuilder()
        ...
        .outputs(metaitem('dustPurifiedIronTwoThreeOxide').first() * 7)
        .fluidOutputs(fluid('hydrogen') * 8000)
        .duration(160)
        .EUt(60)
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .outputs(metaitem('dustIronSulfate').first() * 6)
...
BR.recipeBuilder()
        ...
        .inputs(ore('dustCopperIiOxide') * 1)
...
ALLOY_SMELTER.recipeBuilder()
    .inputs(ore('dustCopperIiOxide') * 2)
