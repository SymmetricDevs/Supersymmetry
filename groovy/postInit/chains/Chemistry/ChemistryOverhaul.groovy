...
CSTR.recipeBuilder()
.fluidInputs(fluid('dichloroethane_isophthalic_acid_solution') * 50)
.fluidInputs(fluid('phosgene') * 50)
.fluidOutputs(fluid('isophthaloyl_dichloride_solution') * 100)
...
CSTR.recipeBuilder()
.fluidInputs(fluid('isophthaloyl_dichloride_solution') * 100)
...
BR.recipeBuilder()
        ...
        .inputs(metaitem('dustCupricOxide') * 1)
...
BR.recipeBuilder()
        .inputs(metaitem('dustZirconiumTetrachlorideTetrahydrofuranComplex') * 7)
