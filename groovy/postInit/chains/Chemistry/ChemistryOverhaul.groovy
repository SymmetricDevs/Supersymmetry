...
.fluidOutputs(fluid('caprolactam_solution') * 1000)
.duration(160)
.EUt(30)
.buildAndRegister()

BR.recipeBuilder()
.fluidInputs(fluid('caprolactam_solution') * 1000)
.fluidInputs(fluid('ammonia_solution') * 2000)
.fluidOutputs(fluid('neutralized_caprolactam_solution') * 3000)
.duration(160)
.EUt(30)
.buildAndRegister()

CENTRIFUGE.recipeBuilder()
.fluidInputs(fluid('neutralized_caprolactam_solution') * 3000)
.fluidInputs(fluid('toluene') * 1000)
.fluidOutputs(fluid('extracted_caprolactam_solution') * 1000)
.fluidOutputs(fluid('dilute_ammonium_sulfate_solution') * 1000)
.duration(160)
.EUt(30)
.buildAndRegister()

DISTILLERY.recipeBuilder()
.fluidInputs(fluid('dilute_ammonium_sulfate_solution') * 1000)
