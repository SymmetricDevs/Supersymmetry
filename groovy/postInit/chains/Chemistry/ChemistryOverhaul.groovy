...
.fluidInputs(fluid('hot_hp_carbon_monoxide') * 50)
.fluidInputs(fluid('hot_hp_hydrogen') * 100)
//.notConsumable(ore('catalystBedDicobaltOctacarbonyl') * 1) TODO: Catalyst Bed
...
BR.recipeBuilder() 
    //.fluidInputs(fluid('phosphorus_trichloride') * 1000)  TODO: phosphorous trichloride
...
ROASTER.recipeBuilder()
    .inputs(ore('dustTriphenylphosphine') * 36)
    .fluidInputs(fluid('chlorine') * 2000)
...
FBR.recipeBuilder()
    ...
    //.notConsumable(ore('catalystBedImpregnatedCopperOxide') * 1) TODO: Copper oxide impregnated catalyst bed
    .fluidOutputs(fluid('methanol') * 50)
    .duration(10)
    .EUt(Globals.voltAmps[1])
    .buildAndRegister()
