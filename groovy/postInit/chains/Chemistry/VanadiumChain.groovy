...
ELECTROMAGNETIC_SEPARATOR.recipeBuilder()
        .inputs(metaitem('dustImpureVanadiferousTitanomagnetite'))
...
MIXER.recipeBuilder()
        ...
        .inputs(metaitem('dustVanadiferousTitanomagnetite') * 8)
...
BR.recipeBuilder()
        .inputs(metaitem('dustMagnesiumChloride') * 3)
...
ROASTER.recipeBuilder()
        .inputs(metaitem('dustMagnesiumHydroxide') * 5)
...
MIXER.recipeBuilder()
        ...
        .inputs(metaitem('dustMagnesiumCarbonate') * 5)
    ...
    if (!fuel.isPlasma) {
        for (comburent in sintering_comburents) {
            ROTARY_KILN.recipeBuilder()
                    .inputs(metaitem('dustVtmConcentrate') * 11)
                    .inputs(metaitem('dustCoke') * 7)
                    .inputs(metaitem('dustDolomite'))
...
CENTRIFUGE.recipeBuilder()
        .inputs(metaitem('dustAlkaliVtSlag') * 7)
...
CENTRIFUGE.recipeBuilder()
        .inputs(metaitem('dustTitaniaSlag'))
