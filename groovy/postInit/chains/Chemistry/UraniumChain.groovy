...
LCR.recipeBuilder()
        ...
        .inputs(metaitem('sodium_chlorate_dust') * 5)
...
ROASTER.recipeBuilder()
        .inputs(metaitem('dustAluminiumCarbonate') * 14)
...
ROASTER.recipeBuilder()
        .inputs(metaitem('dustIronCarbonate') * 5)
