...
EBF.recipeBuilder()
    ...
    .outputs(ore('dustCobaltOxide').first() * 2)
    .chancedOutput(ore('dustArsenicTrioxide').first() * 5, 7500, 0)
...
EBF.recipeBuilder()
    ...
    .chancedOutput(ore('dustArsenicTrioxide').first() * 10, 7500, 0)
...
BATCH_REACTOR.recipeBuilder()
        ...
        .outputs(ore('dustSilverChloride').first() * 6) //TO SILVER PROCESSING
...
BATCH_REACTOR.recipeBuilder()
        ...
        .outputs(ore('dustSodiumHydroxide').first() * 9)
