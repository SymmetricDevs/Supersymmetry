...
//GALENA
MIXER.recipeBuilder()
        .inputs(metaitem('dustImpureGalena') * 8)
...
FLOTATION.recipeBuilder()
        ...
        .notConsumable(metaitem('dustSodiumEthylXanthate'))
        .fluidOutputs(fluid('byproduct_sphalerite_slurry') * 1000)
...
CLARIFIER.recipeBuilder()
        .fluidInputs(fluid('byproduct_sphalerite_slurry') * 1000)
...
//CERUSSITE
MIXER.recipeBuilder()
        .inputs(metaitem('dustImpureCerussite') * 8)
...
//ANGLESITE
MIXER.recipeBuilder()
        .inputs(metaitem('dustImpureAnglesite') * 8)
        .fluidInputs(fluid('distilled_water') * 2000)
