...
ROASTER.recipeBuilder()
        .inputs(metaitem('dustCerussite') * 5)
...
SINTERING_OVEN.recipeBuilder()
        .inputs(metaitem('dustAnglesite') * 6)
        .outputs(metaitem('dustSinteredLeadConcentrate') * 2)
...
BR.recipeBuilder()
        ...
        .outputs(metaitem('dustArsenicPentoxide') * 7)
...
BR.recipeBuilder()
        ...
        .fluidOutputs(fluid('saltwater') * 2000)
        .EUt(120)
        .duration(200)
        .buildAndRegister()
...
ROASTER.recipeBuilder()
        ...
        .outputs(metaitem('black_metal'))
        .EUt(Globals.voltAmps[3])
        .duration(400)
        .buildAndRegister()

ROASTER.recipeBuilder()
        .inputs(metaitem('black_metal') * 50)
        .fluidInputs(fluid('oxygen') * 9000)
        .outputs(metaitem('antimony_arsenic_flue_dust') * 3)
        .outputs(metaitem('burned_black_metal') * 2)
        .EUt(Globals.voltAmps[3])
        .duration(400)
        .buildAndRegister()

REACTION_FURNACE.recipeBuilder()
        .inputs(metaitem('burned_black_metal') * 2)
