...
FBR.recipeBuilder()
        .inputs(metaitem('dustMethylenedianiline') * 8)
...
POLYMERIZATION.recipeBuilder()
        .inputs(metaitem('dustMethyleneDiphenylDiisocyanate') * 10)
        .fluidInputs(fluid('glycerol') * 1000)
        .fluidInputs(fluid('ethylene_glycol') * 250)
        .inputs(metaitem('dustTriethylenediamine') * 1)
...
CHEMICAL_BATH.recipeBuilder()
        .inputs(metaitem('blockPolyurethane'))
