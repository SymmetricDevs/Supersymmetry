...
BR.recipeBuilder()
        .fluidInputs(fluid('three_four_dichloro_one_butene') * 1000)
        .fluidInputs(fluid('sodium_hydroxide_solution') * 2000)
        .fluidInputs(fluid('distilled_water') * 1000)
        .fluidOutputs(fluid('chloroprene_solution') * 1000)
...
POLYMERIZATION_TANK.recipeBuilder()
        ...
        .fluidInputs(fluid('chloroprene_solution') * 1000)
        .fluidOutputs(fluid('neoprene_solution') * 1000)
        .EUt(VA[MV])
        .duration(180)
        .buildAndRegister()
...
VULCANIZER.recipeBuilder()
        ...
        .fluidInputs(fluid('neoprene_solution') * 1000)
        .outputs(metaitem('dustNeoprene'))
