...
CSTR.recipeBuilder()
        ...
        .fluidOutputs(fluid('dichlorobutene_mixture') * 50)
        .EUt(VA[MV])
        .duration(1)
        .buildAndRegister()

BR.recipeBuilder()
        .inputs(metaitem('dustTinyBisBenzonitrilePalladiumIiChloride'))
        .fluidInputs(fluid('dichlorobutene_mixture') * 1000)
        .fluidOutputs(fluid('three_four_dichloro_one_butene') * 1000)
        .EUt(VA[MV])
        .duration(50)
        .buildAndRegister()

CSTR.recipeBuilder()
        .fluidInputs(fluid('three_four_dichloro_one_butene') * 50)
        .fluidInputs(fluid('sodium_hydroxide_solution') * 50)
        .fluidOutputs(fluid('crude_chloroprene') * 50)
...
VACUUM_FREEZER.recipeBuilder()
        .fluidInputs(fluid('crude_chloroprene') * 1000)
        .fluidOutputs(fluid('dried_chloroprene') * 1000)
        .EUt(VA[MV])
        .duration(80)
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('dried_chloroprene') * 1000)
        .fluidOutputs(fluid('chloroprene') * 1000)
        .EUt(VA[LV])
        .duration(60)
        .buildAndRegister()

BR.recipeBuilder()
        .inputs(metaitem('dustPotassiumPersulfate') * 3)
        .fluidInputs(fluid('potassium_isopropyl_xanthate_solution') * 1000)
        .outputs(metaitem('dustDiisopropylDixanthogenDisulfide'))
...
POLYMERIZATION_TANK.recipeBuilder()
        ...
        .fluidOutputs(fluid('neoprene_latex') * 1000)
        .EUt(VA[HV])
        .duration(80)
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('neoprene_latex') * 1000)
        .outputs(metaitem('dustNeopreneLatex'))
...
VULCANIZER.recipeBuilder()
        .inputs(metaitem('dustNeopreneLatex') * 4)
        .notConsumable(metaitem('shape.mold.ingot'))
        .outputs(metaitem('ingotNeoprene') * 4)
        .circuitMeta(2)
        .EUt(VA[ULV])
        .duration(600)
        .buildAndRegister()
...
VULCANIZER.recipeBuilder()
        .inputs(metaitem('dustNeopreneLatex') * 4)
        .notConsumable(metaitem('shape.mold.plate'))
        .outputs(metaitem('plateNeoprene') * 4)
        .circuitMeta(2)
        .EUt(VA[ULV])
        .duration(600)
        .buildAndRegister()
...
VULCANIZER.recipeBuilder()
        ...
        .outputs(metaitem('foilNeoprene') * 16)
        .circuitMeta(2)
        .EUt(VA[ULV])
        .duration(600)
        .buildAndRegister()
...
VULCANIZER.recipeBuilder()
        ...
        .outputs(metaitem('ringNeoprene') * 16)
        .circuitMeta(2)
        .EUt(VA[ULV])
        .duration(600)
        .buildAndRegister()
