...
MIXER.recipeBuilder()
    .inputs(ore('dustAcidWashedSiliconDioxide') * 9)
    .inputs(ore('dustAlumina') * 5)
    .inputs(ore('dustMagnesia') * 2)
    .outputs(metaitem('dustSGlass') * 16)
    .duration(320)
    .EUt(VA[MV])
    .buildAndRegister()
...
EXTRUDER.recipeBuilder()
        ...
        .fluidInputs(fluid('s_glass') * 288)
        .outputs(metaitem('s_glass_fibers') * 1)
        .duration(35)
        .EUt(VA[MV])
        .buildAndRegister()
...
CHEMICAL_BATH.recipeBuilder()
        ...
        .fluidInputs(fluid('polycaprolactam') * 144)
        .outputs(metaitem('plateFiberReinforcedNylon'))
        .duration(48)
        .EUt(VA[MV])
        .buildAndRegister()
