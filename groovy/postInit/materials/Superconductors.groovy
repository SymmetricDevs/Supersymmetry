...
def lowTempSuperconductors = ["UraniumTriplatinum", "IndiumTinBariumTitaniumCuprate", "UraniumRhodiumDinaquadide", "EnrichedNaquadahTriniumEuropiumDuranide", "RutheniumTriniumAmericiumNeutronate"]
...
def lowTempSuperconductorsLowerCase = ["uraniumtriplatinum", "indiumtinbariumtitaniumcuprate", "uraniumrhodiumdinaquadide", "enrichednaquadahtriniumeuropiumduranide", "rutheniumtriniumamericiumneutronate"]
...
for (i = 0; i < lowTempSuperconductors.size(); i++) {
...
mods.gregtech.electric_blast_furnace.removeByInput(120, [metaitem('dustManganesePhosphide'), metaitem('circuit.integrated').withNbt(['Configuration': 2])], [fluid('nitrogen') * 1000])



CANNER.recipeBuilder()
        .inputs(metaitem('fused_quartz_tube'))
        .inputs(ore('dustManganesePhosphide'))
        .outputs(metaitem('cannedmanganesephosphide'))
        .duration(200)
        .EUt(VA[LV])
        .buildAndRegister();
...
EXTRUDER.recipeBuilder()
        .inputs(metaitem('tubemanganesephosphide'))
        .notConsumable(metaitem('shape.extruder.wire'))
        .outputs(metaitem('basemanganesephosphide') * 16)
        .duration(200)
        .EUt(VA[LV])
        .buildAndRegister();
