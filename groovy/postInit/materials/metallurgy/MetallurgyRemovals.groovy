...
// Bronze Dust * 4
mods.gregtech.blender.removeByInput(7, [metaitem('dustCopper') * 3, metaitem('dustTin'), metaitem('circuit.integrated').withNbt(['Configuration': 1])], null)
// Bronze Ingot * 4
...
// Brass Dust * 4
mods.gregtech.blender.removeByInput(7, [metaitem('dustCopper') * 3, metaitem('dustZinc'), metaitem('circuit.integrated').withNbt(['Configuration': 1])], null)
// Brass Ingot * 4
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('ingotCopper') * 3, metaitem('dustZinc')], null)
// Brass Ingot * 4
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustCopper') * 3, metaitem('ingotZinc')], null)
// Brass Ingot * 4
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('ingotCopper') * 3, metaitem('ingotZinc')], null)
// Brass Ingot * 4
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustCopper') * 3, metaitem('dustZinc')], null)
// Brass Ingot * 4
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('ingotAnnealedCopper') * 3, metaitem('dustZinc')], null)
// Brass Ingot * 4
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustAnnealedCopper') * 3, metaitem('ingotZinc')], null)
// Brass Ingot * 4
...
// Cupronickel Dust * 2
mods.gregtech.blender.removeByInput(24, [metaitem('dustCopper'), metaitem('dustNickel'), metaitem('circuit.integrated').withNbt(['Configuration': 1])], null)
// Cupronickel Ingot * 2
...
// Red Alloy Dust * 1
mods.gregtech.blender.removeByInput(7, [metaitem('dustCopper'), item('minecraft:redstone') * 4 * 4, metaitem('circuit.integrated').withNbt(['Configuration': 2])], null)
// Red Alloy Ingot * 1
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('ingotCopper'), item('minecraft:redstone') * 4 * 4], null)
// Red Alloy Ingot * 1
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustCopper'), item('minecraft:redstone') * 4 * 4], null)
// Red Alloy Ingot * 1
...
// Invar Dust * 3
mods.gregtech.blender.removeByInput(7, [metaitem('dustIron') * 2, metaitem('dustNickel'), metaitem('circuit.integrated').withNbt(['Configuration': 1])], null)
// Invar Ingot * 3
...
// Battery Alloy Ingot * 5
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustLead') * 4, metaitem('ingotAntimony')], null)
// Battery Alloy Ingot * 5
...
// Electrum Ingot * 2
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustGold'), metaitem('ingotSilver')], null)
// Electrum Ingot * 2
...
// Tin Alloy Ingot * 2
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustIron'), metaitem('ingotTin')], null)
// Tin Alloy Ingot * 2
mods.gregtech.alloy_smelter.removeByInput(16, [item('minecraft:iron_ingot'), metaitem('ingotTin')], null)
// Tin Alloy Ingot * 2
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustIron'), metaitem('dustTin')], null)
// Tin Alloy Ingot * 2
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('ingotWroughtIron'), metaitem('dustTin')], null)
// Tin Alloy Ingot * 2
mods.gregtech.alloy_smelter.removeByInput(16, [metaitem('dustWroughtIron'), metaitem('ingotTin')], null)
// Tin Alloy Ingot * 2
