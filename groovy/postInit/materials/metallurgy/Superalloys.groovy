...
INDUCTION_FURNACE.recipeBuilder()
    .inputs(metaitem('dustIron') * 12)
    .inputs(metaitem('dustNickel') * 8)
...
INDUCTION_FURNACE.recipeBuilder()
    .inputs(metaitem('dustIron') * 9)
    .inputs(metaitem('dustNickel') * 16)
...
INDUCTION_FURNACE.recipeBuilder()
    .inputs(metaitem('dustIron') * 20)
    .inputs(metaitem('dustNickel') * 30)
