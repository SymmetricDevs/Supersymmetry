...
ASSEMBLER.recipeBuilder()
        ...
        .inputs(metaitem('plateSteel') * 6)
        .inputs(ore('wireGtHexTin') * 2)
...
ASSEMBLER.recipeBuilder()
        ...
        .inputs(metaitem('plateAluminum') * 6)
        .inputs(ore('wireGtHexCopper') * 2)
...
ASSEMBLER.recipeBuilder()
        ...
        .inputs(ore('wireGtHexAluminium') * 2)
...
ASSEMBLER.recipeBuilder()
        .inputs(metaitem('transformer.adjustable.ev') * 2)
        .inputs(metaitem('susy:energy_hatch.input_4a.ev'))
        .inputs(metaitem('plateTitanium') * 10)
        .inputs(ore('wireGtHexAluminium') * 2)
        .inputs(ore('wireGtOctalAluminium') * 2)
