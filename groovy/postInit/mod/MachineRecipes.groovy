...
for (i = 1; i <= 4; i++) {
    RecyclingHelper.addShaped("gregtech:vulcanizing_press." + Globals.voltageTiers[i], metaitem('susy:vulcanizing_press.' + Globals.voltageTiers[i]), [
            [tieredCables[i], pistons[i], tieredCables[i]],
...
RecyclingHelper.addShaped("gregtech:vulcanizing_press.steel", metaitem('susy:vulcanizing_press.steel'), [
    ...
    [metaitem('pipeSmallFluidIron'), metaitem('susy:vulcanizing_press.bronze'), metaitem('pipeSmallFluidIron')],
...
RecyclingHelper.addShaped("gregtech:mixer.steel", metaitem('susy:mixer.steel'), [
    [metaitem('pipeSmallFluidIron'), metaitem('plateSteel'), metaitem('pipeSmallFluidIron')],
    [metaitem('plateWroughtIron'), metaitem('susy:mixer.bronze'), metaitem('plateWroughtIron')],
    [metaitem('pipeSmallFluidIron'), metaitem('pipeSmallFluidIron'), metaitem('pipeSmallFluidIron')]
])

RecyclingHelper.addShaped("gregtech:vacuum_chamber.steel", metaitem('susy:vacuum_chamber.steel'), [
    [metaitem('plateSteel'), metaitem('pipeSmallFluidIron'), metaitem('plateSteel')],
    [metaitem('pipeSmallFluidIron'), metaitem('susy:vacuum_chamber.bronze'), metaitem('pipeSmallFluidIron')],
    [metaitem('plateWroughtIron'), metaitem('pipeSmallFluidIron'), metaitem('plateWroughtIron')]
])
...
RecyclingHelper.addShaped("gregtech:batch_reactor.steel", metaitem('susy:batch_reactor.steel'), [
        [metaitem('plateSteel'), metaitem('pipeSmallFluidIron'), metaitem('plateSteel')],
        [metaitem('pipeSmallFluidIron'), metaitem('susy:batch_reactor.bronze'), metaitem('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), metaitem('pipeSmallFluidIron'), metaitem('plateWroughtIron')]
])

RecyclingHelper.addShaped("gregtech:distiller.steel", metaitem('susy:distiller.steel'), [
        [metaitem('plateSteel'), ore('pipeSmallFluidIron'), metaitem('plateSteel')],
        [ore('pipeSmallFluidIron'), metaitem('susy:distiller.bronze'), ore('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), ore('pipeSmallFluidIron'), metaitem('plateWroughtIron')]
])

RecyclingHelper.replaceShaped("gregtech:steam_compressor_steel", metaitem('gregtech:steam_compressor_steel'), [
    [ore('pipeSmallFluidIron'), metaitem('plateSteel'), ore('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), metaitem('gregtech:steam_compressor_bronze'), metaitem('plateWroughtIron')],
        [ore('pipeSmallFluidIron'), ore('pipeSmallFluidIron'), ore('pipeSmallFluidIron')]
])

RecyclingHelper.replaceShaped("gregtech:rock_breaker_steel", metaitem('steam_rock_breaker_steel'), [
        [metaitem('plateWroughtIron'), metaitem('plateSteel'), metaitem('plateWroughtIron')],
        [ore('pipeSmallFluidIron'), metaitem('steam_rock_breaker_bronze'),  ore('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), metaitem('plateWroughtIron'), metaitem('plateWroughtIron')],
])

RecyclingHelper.replaceShaped("gregtech:steam_furnace_steel", metaitem('gregtech:steam_furnace_steel'), [
    	[ore('pipeSmallFluidIron'), metaitem('plateSteel'), ore('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), metaitem('gregtech:steam_furnace_bronze'),  metaitem('plateWroughtIron')],
        [ore('pipeSmallFluidIron'), ore('pipeSmallFluidIron'), ore('pipeSmallFluidIron')]
])

RecyclingHelper.replaceShaped("gregtech:macerator_steel", metaitem('gregtech:steam_macerator_steel'), [
        [metaitem('plateWroughtIron'), metaitem('plateSteel'), metaitem('plateWroughtIron')],
        [ore('pipeSmallFluidIron'), metaitem('gregtech:steam_macerator_bronze'), ore('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), metaitem('plateWroughtIron'), metaitem('plateWroughtIron')],
])

RecyclingHelper.replaceShaped("gregtech:alloy_smelter_steel", metaitem('gregtech:steam_alloy_smelter_steel'), [
        [metaitem('plateWroughtIron'), metaitem('plateSteel'), metaitem('plateWroughtIron')],
        [metaitem('plateWroughtIron'), metaitem('gregtech:steam_alloy_smelter_bronze'), metaitem('plateWroughtIron')],
        [metaitem('plateWroughtIron'), ore('pipeSmallFluidIron'), metaitem('plateWroughtIron')],
])

RecyclingHelper.replaceShaped("gregtech:extractor_steel", metaitem('gregtech:steam_extractor_steel'), [
    	[ore('pipeSmallFluidIron'), metaitem('plateSteel'), ore('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), metaitem('gregtech:steam_extractor_bronze'), metaitem('plateWroughtIron')],
        [ore('pipeSmallFluidIron'), ore('pipeSmallFluidIron'), ore('pipeSmallFluidIron')]
])

RecyclingHelper.replaceShaped("gregtech:forge_hammer_steel", metaitem('gregtech:steam_hammer_steel'), [
        [metaitem('plateWroughtIron'), metaitem('plateSteel'), metaitem('plateWroughtIron')],
        [ore('pipeSmallFluidIron'), metaitem('gregtech:steam_hammer_bronze'), ore('pipeSmallFluidIron')],
        [metaitem('plateWroughtIron'), metaitem('plateWroughtIron'), metaitem('plateWroughtIron')],
])
...
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 0))
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 1))
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 2))
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 3))
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 4))
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 5))
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 6))
mods.chisel.carving.addVariation("active_blocks", item('susy:wire_coil_active', 7))
mods.chisel.carving.addVariation("active_blocks", item('susy:heating_coil_active', 0))
mods.chisel.carving.addVariation("active_blocks", item('susy:heating_coil_active', 1))

mods.chisel.carving.addVariation("active_blocks", item('susy:cooling_coil_active', 0))
mods.chisel.carving.addVariation("active_blocks", item('susy:cooling_coil_active', 1))
mods.chisel.carving.addVariation("active_blocks", item('susy:cooling_coil_active', 2))

mods.chisel.carving.addVariation("active_blocks", item('susy:firebox_active', 0))
mods.chisel.carving.addVariation("active_blocks", item('susy:firebox_active', 1))
mods.chisel.carving.addVariation("active_blocks", item('susy:firebox_active', 2))
mods.chisel.carving.addVariation("active_blocks", item('susy:firebox_active', 3))

mods.chisel.carving.addVariation("active_blocks", item('susy:engine_intake_active', 0))
mods.chisel.carving.addVariation("active_blocks", item('susy:engine_intake_active', 1))

mods.chisel.carving.addVariation("active_blocks", item('susy:assembly_line_active', 0))


mods.chisel.carving.addVariation("active_blocks", item('susy:fusion_casing_active', 0))
mods.chisel.carving.addVariation("active_blocks", item('susy:fusion_casing_active', 1))
mods.chisel.carving.addVariation("active_blocks", item('susy:fusion_casing_active', 2))

mods.chisel.carving.addVariation("active_blocks", item('susy:heat_vent_active', 3))

mods.chisel.carving.addVariation("active_blocks", item('susy:sintering_brick_active', 0))
mods.chisel.carving.addVariation("active_blocks", item('susy:sintering_brick_active', 0))

mods.chisel.carving.addVariation("active_blocks", item('susy:evaporation_bed_active', 0))

mods.chisel.carving.addVariation("active_blocks", item('susy:electrode_assembly_active', 0))

mods.chisel.carving.addVariation("active_blocks", item('susy:serpentine_active', 0))

mods.chisel.carving.addVariation("active_blocks", item('susy:basic_intake_casing_active', 0))

mods.chisel.carving.addVariation("active_blocks", item('susy:eccentric_roll_active', 0))

mods.chisel.carving.addGroup("active_inverted_blocks")


mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 0))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 1))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 2))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 3))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 4))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 5))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 6))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:wire_coil_active_inverted', 7))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:heating_coil_active_inverted', 0))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:heating_coil_active_inverted', 1))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:cooling_coil_active_inverted', 0))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:cooling_coil_active_inverted', 1))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:cooling_coil_active_inverted', 2))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:firebox_active_inverted', 0))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:firebox_active_inverted', 1))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:firebox_active_inverted', 2))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:firebox_active_inverted', 3))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:engine_intake_active_inverted', 0))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:engine_intake_active_inverted', 1))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:assembly_line_active_inverted', 0))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:fusion_casing_active_inverted', 0))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:fusion_casing_active_inverted', 1))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:fusion_casing_active_inverted', 2))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:heat_vent_active_inverted', 3))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:sintering_brick_active_inverted', 0))
mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:sintering_brick_active_inverted', 0))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:evaporation_bed_active_inverted', 0))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:electrode_assembly_active_inverted', 0))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:serpentine_active_inverted', 0))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:basic_intake_casing_active_inverted', 0))

mods.chisel.carving.addVariation("active_inverted_blocks", item('susy:eccentric_roll_active_inverted', 0))
...
ASSEMBLER.recipeBuilder()
    .inputs(metaitem('electric.motor.lv') * 3)
    .inputs(ore('circuitLv') * 2)
	.inputs(ore('plateSteel'))
    .inputs(ore('cableGtSingleTin'))
    .outputs(item('susy:alternator_coil', 0))
    .duration(200)
    .EUt(VA[LV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    ...
    .outputs(item('susy:turbine_rotor', 0))
    .duration(200)
    .EUt(VA[LV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
	...
	.inputs(ore('pipeSmallFluidSteel') * 4)
    .outputs(item('gregtech:machine', 18001))
    .duration(200)
    .EUt(VA[LV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(ore('circuitLv'))
    .inputs(metaitem('electric.pump.lv'))
	.inputs(ore('pipeSmallItemNickel') * 4)
    .outputs(item('gregtech:machine', 18002))
    .duration(200)
    .EUt(VA[LV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    .inputs(metaitem('hull.lv'))
    .inputs(ore('circuitLv') * 2)
	.inputs(ore('pipeSmallItemNickel') * 2)
    .inputs(metaitem('emitter.lv'))
    .inputs(metaitem('sensor.lv'))
    .outputs(item('gregtech:machine', 18004))
    .duration(200)
    .EUt(VA[LV])
    .buildAndRegister();
...
RecyclingHelper.replaceShaped("gregtechfoodoption:steam_baking_oven", metaitem('gregtechfoodoption:steam_baking_oven'), [
        ...
        [item('gregtechfoodoption:gtfo_casing', 1), metaitem('gregtechfoodoption:baking_oven'), metaitem('pipeSmallFluidIron')],
...
//Multiblock Tank Assembler Recipes
ASSEMBLER.recipeBuilder()
    .inputs(item('gregtech:planks:1') * 4)
	.inputs(ore('plateLead'))
    .outputs(item('gregtech:steam_casing', 5))
    .duration(25)
    .EUt(VA[ULV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(ore('ringLead'))
    .inputs(ore('rotorLead'))
    .outputs(item('gregtech:machine', 1596))
    .duration(100)
    .EUt(VA[ULV])
    .buildAndRegister();
...
//Crafting Station Assembler Recipe
ASSEMBLER.recipeBuilder()
    .inputs(ore('chestWood') * 2)
    .inputs(item('minecraft:crafting_table'))
    .inputs(ore('slabWood') * 2)
    .inputs(ore('plankWood') * 4)
    .outputs(item('gregtech:machine', 1647))
    .duration(100)
    .EUt(16)
    .buildAndRegister();

//Coagulation Tank Assembler Recipes
ASSEMBLER.recipeBuilder()
    .inputs(ore('plankTreatedWood') * 4)
    .inputs(metaitem('pipeLargeFluidTreatedWood'))
    .inputs(ore('rotorSteel'))
    .inputs(ore('screwSteel'))
    .outputs(item('gregtech:machine', 14501))
    .EUt(VA[LV])
    .duration(200)
    .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
    .inputs(ore('plankTreatedWood') * 4)
    .inputs(ore('frameGtTreatedWood'))
    .inputs(ore('boltSteel') * 2)
    .outputs(item('susy:coagulation_tank_wall', 0))
//Attrition Scrubber
...
//Wooden Barrel Assembler Recipe
ASSEMBLER.recipeBuilder()
    .inputs(ore('plankWood') * 4)
    .inputs(ore('stickLongBronze') * 2)
    .fluidInputs(fluid('glue') * 100)
    .outputs(metaitem('drum.wood'))
    .duration(200)
    .EUt(VA[ULV])
    .buildAndRegister()
