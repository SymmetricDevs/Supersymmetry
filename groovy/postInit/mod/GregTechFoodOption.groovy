...
def allPastaMold = ['tagliatelle', 'spaghetti', 'lasagna', 'rigatoni', 'ditalini']

for (pasta in allPastaMold) {

FORMING_PRESS.recipeBuilder()
    .notConsumable(metaitem('gregtechfoodoption:shape.pasta.' + pasta))
    .inputs(metaitem('gregtechfoodoption:shape.pasta.blank'))
    .outputs(metaitem('gregtechfoodoption:shape.pasta.' + pasta))
    .duration(120)
    .EUt(22)
    .buildAndRegister();
}
...
FORMING_PRESS.recipeBuilder()
    .notConsumable(metaitem('gregtechfoodoption:config.slicer_blade.flat'))
    .inputs(metaitem('shape.extruder.block'))
    .inputs(ore('screwIron'))
    .inputs(ore('plateIron') * 2)
    .outputs(metaitem('gregtechfoodoption:config.slicer_blade.flat'))
    .duration(120)
    .EUt(22)
    .buildAndRegister()

FORMING_PRESS.recipeBuilder()
    .notConsumable(metaitem('gregtechfoodoption:config.slicer_blade.stripes'))
    .inputs(metaitem('shape.extruder.block'))
    .inputs(ore('screwIron'))
    .inputs(ore('plateIron') * 4)
    .outputs(metaitem('gregtechfoodoption:config.slicer_blade.stripes'))
    .duration(120)
    .EUt(22)
    .buildAndRegister()

FORMING_PRESS.recipeBuilder()
    .notConsumable(metaitem('gregtechfoodoption:config.slicer_blade.octagonal'))
    .inputs(metaitem('shape.extruder.block'))
    .inputs(ore('screwIron'))
    .inputs(ore('plateIron') * 4)
    .outputs(metaitem('gregtechfoodoption:config.slicer_blade.octagonal'))
    .duration(120)
    .EUt(22)
    .buildAndRegister()
...
def allWoodenForm = ['bread', 'baguette', 'bun']

allWoodenForm.eachWithIndex { woodenForm, i ->

    CUTTER.recipeBuilder()
        .circuitMeta(i + 1)
        .inputs(metaitem('wooden_form.empty'))
        .outputs(metaitem('gregtechfoodoption:wooden_form.' + woodenForm))
        .duration(40)
        .EUt(VA[LV])
        .buildAndRegister();
}
