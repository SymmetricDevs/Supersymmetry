...
MIXER.recipeBuilder()
        .inputs(item('gregtechfoodoption:gtfo_meta_item:320'))
...
BR.recipeBuilder()
        ...
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1113') * 10)
        .duration(100)
        .EUt(30)
        .buildAndRegister()
...
CENTRIFUGE.recipeBuilder()
        ...
        .inputs(item('gregtechfoodoption:gtfo_oredict_item:1113') * 10)
        .fluidOutputs(fluid('gtfo_sludge') * 1000)
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1114') * 6)
        .duration(100)
        .EUt(30)
        .buildAndRegister()

ROASTER.recipeBuilder()
        .inputs(item('gregtechfoodoption:gtfo_oredict_item:1114') * 6)
...
MIXER.recipeBuilder()
        .inputs(item('gregtechfoodoption:gtfo_meta_item:207'))
        .fluidInputs(fluid('gtfo_baking_soda_solution') * 500)
        .outputs(item('gregtechfoodoption:gtfo_meta_item:209'))
        .duration(100)
        .EUt(30)
        .buildAndRegister()
...
for (ItemStack fish : GTFOUtils.getFish()) {
    CHEMICAL_BATH.recipeBuilder()
            ...
            .inputs(fish)
            .outputs(item('gregtechfoodoption:gtfo_meta_item:219'))
            .EUt(16)
            .duration(400)
            .buildAndRegister();
    ...
    FERMENTER.recipeBuilder()
            ...
            .inputs(fish)
            .outputs(item('gregtechfoodoption:gtfo_meta_item:117'))
            .EUt(8)
            .duration(100)
            .buildAndRegister();
}
...
MIXER.recipeBuilder()
        .inputs(item('gregtechfoodoption:gtfo_meta_item:91') * 4)
...
CENTRIFUGE.recipeBuilder()
        ...
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1106'))
...
FERMENTER.recipeBuilder()
        .inputs(item('gregtechfoodoption:gtfo_meta_item:314') * 64)
        .fluidInputs(fluid('air') * 10000)
        .outputs(item('gregtechfoodoption:gtfo_meta_item:312') * 64)
        .duration(36000)
        .EUt(2)
        .buildAndRegister()
...
for (ItemStack meat : GTFOUtils.getMeat()) {
    FERMENTER.recipeBuilder()
            .fluidInputs(fluid('water') * 100)
            .inputs(meat)
            .outputs(item('gregtechfoodoption:gtfo_meta_item:118'))
            .EUt(8)
            .duration(100)
            .buildAndRegister();
...
LCR.recipeBuilder()
        .fluidInputs(fluid('methanol') * 4000)
        .fluidInputs(fluid('chloroform') * 4000)
        .inputs(item('gregtechfoodoption:gtfo_meta_item:134') * 32)
...
CHEMICAL_BATH.recipeBuilder()
        .inputs(item('gregtechfoodoption:gtfo_meta_item:134'))
...
FLUIDIZEDBR.recipeBuilder()
        ...
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1094') * 23)
        .duration(120)
        .EUt(2000)
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .inputs(item('gregtechfoodoption:gtfo_oredict_item:1094') * 23)
...
BR.recipeBuilder()
        ...
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1097') * 24)
...
BR.recipeBuilder()
        ...
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1123') * 24)
        .duration(160)
        .EUt(120)
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .inputs(item('gregtechfoodoption:gtfo_oredict_item:1123') * 24)
        .fluidOutputs(fluid('water') * 1000)
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1124') * 22)
        .duration(160)
        .EUt(120)
        .buildAndRegister()
...
LCR.recipeBuilder()
        ...
        .inputs(item('gregtechfoodoption:gtfo_oredict_item:1124') * 22)
        .fluidOutputs(fluid('diluted_hydrochloric_acid') * 1000)
        .fluidOutputs(fluid('carbon_dioxide') * 1000)
        .outputs(item('gregtechfoodoption:gtfo_oredict_item:1125') * 19)
        .duration(240)
        .EUt(120)
        .buildAndRegister()
