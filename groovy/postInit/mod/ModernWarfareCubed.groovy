...
mods.gregtech.assembler.recipeBuilder()
        ...
        .inputs(metaitem('platePlastic') * 6)
	.inputs(metaitem('springSmallSteel') * 2)
		.circuitMeta(23)
        .outputs(item('mwc:ump45mag'))
        .duration(120)
        .EUt(120)
        .buildAndRegister();
...
mods.gregtech.assembler.recipeBuilder()
        .fluidInputs(fluid('plastic') * 288)
        .inputs(metaitem('platePlastic') * 8)
		.circuitMeta(25)
        .outputs(item('mwc:ump45receiver'))
        .duration(200)
        .EUt(120)
        .buildAndRegister();
...
mods.gregtech.assembler.recipeBuilder()
        ...
        .inputs(metaitem('ingotSteel') * 4)
        .inputs(metaitem('boltSteel') * 1)
		.circuitMeta(20)
        .outputs(metaitem('ump_45.bolt'))
        .duration(300)
        .EUt(120)
        .buildAndRegister();
...
mods.gregtech.assembler.recipeBuilder()
        ...
        .inputs(metaitem('springSteel') * 2)
        .inputs(metaitem('stickSteel') * 2)
		.circuitMeta(20)
        .outputs(metaitem('ump_45.recoil_spring_assembly'))
        .duration(200)
        .EUt(120)
        .buildAndRegister();

mods.gregtech.forming_press.recipeBuilder()
        .inputs(metaitem('ingotSteel') * 2)
        .notConsumable(metaitem('shape.extruder.ring'))
		.circuitMeta(20)
        .outputs(metaitem('ump_45.8inch_unrifled_barrel'))
        .duration(400)
        .EUt(120)
        .buildAndRegister();

mods.gregtech.lathe.recipeBuilder()
        .inputs(metaitem('ump_45.8inch_unrifled_barrel'))
        .outputs(metaitem('ump_45.8inch_barrel'))
        .duration(400)
        .EUt(120)
        .buildAndRegister();

mods.gregtech.lathe.recipeBuilder()
        .inputs(metaitem('ump_45.8inch_barrel'))
        .outputs(metaitem('ump_45.8inch_threaded_barrel'))
        .duration(80)
        .EUt(120)
        .buildAndRegister();
...
mods.gregtech.assembler.recipeBuilder()
		...
		.circuitMeta(21)
        .outputs(metaitem('ump_45.selector_left'))
        .duration(80)
        .EUt(30)
        .buildAndRegister();
...
mods.gregtech.assembler.recipeBuilder()
        .inputs(metaitem('platePlastic') * 1)
		.circuitMeta(22)
        .outputs(metaitem('ump_45.selector_right'))
        .duration(80)
        .EUt(30)
        .buildAndRegister();

mods.gregtech.assembler.recipeBuilder()
        .inputs(metaitem('ump_45.selector_left') * 1)
        .inputs(metaitem('ump_45.selector_right') * 1)
        .inputs(metaitem('boltSteel') * 1)
		.circuitMeta(20)
        .outputs(metaitem('ump_45.selector_ambi'))
        .duration(80)
        .EUt(30)
        .buildAndRegister();

mods.gregtech.assembler.recipeBuilder()
        .inputs(metaitem('stickSteel') * 1)
        .inputs(metaitem('boltSteel') * 1)
		.circuitMeta(20)
        .outputs(metaitem('ump_45.trigger'))
        .duration(80)
        .EUt(30)
        .buildAndRegister();
...
mods.gregtech.assembler.recipeBuilder()
        ...
        .inputs(metaitem('platePlastic') * 4)
		.circuitMeta(20)
        .outputs(metaitem('ump_45.pistol_grip'))
        .duration(200)
        .EUt(120)
        .buildAndRegister();
...
mods.gregtech.assembler.recipeBuilder()
        .fluidInputs(fluid('plastic') * 432)
        .inputs(metaitem('platePlastic') * 4)
        .inputs(metaitem('springSmallSteel') * 5)
        .inputs(metaitem('boltSteel') * 4)
        .inputs(metaitem('ump_45.selector_ambi') * 1)
        .inputs(metaitem('plateSteel') * 1)
        .inputs(metaitem('ump_45.pistol_grip') * 1)
        .inputs(metaitem('ump_45.trigger') * 1)
		.circuitMeta(24)
        .outputs(metaitem('ump_45.trigger_group'))
        .duration(600)
        .EUt(120)
        .buildAndRegister();
...
mods.gregtech.weapons_factory.recipeBuilder()
        .fluidInputs(fluid('plastic') * 576)
        .fluidInputs(fluid('steel') * 144)
        .inputs(item('mwc:ump45receiver') * 1)
        .inputs(item('mwc:ump45stock') * 1)
        .inputs(metaitem('ump_45.trigger_group') * 1)
        .inputs(metaitem('ump_45.bolt') * 1)
        .inputs(metaitem('ump_45.8inch_threaded_barrel') * 1)
        .inputs(metaitem('ump_45.recoil_spring_assembly') * 1)
		.circuitMeta(24)
        .outputs(item('mwc:ump_45'))
        .duration(1800)
        .EUt(480)
        .buildAndRegister();