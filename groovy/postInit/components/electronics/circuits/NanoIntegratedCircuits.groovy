...
def generateCMOSFabrication(String componentName, int circ) {
    ...
    Deposition.generateChemicalVaporDepositionRecipe('wafer.' + componentName + '.step_thirty_six', 'wafer.' + componentName + '.step_thirty_seven', 400, 'silicon_nitride.teos')
    ...
    Deposition.generateChemicalVaporDepositionRecipe('wafer.' + componentName + '.step_forty_four', 'wafer.' + componentName + '.step_forty_five', 400, 'silicon_germanium.epitaxy', 1) // Epitaxial deposition of SiGe in PMOS source/drain recesses
    ...
    Deposition.generateChemicalVaporDepositionRecipe('wafer.' + componentName + '.step_fifty_one', 'wafer.' + componentName + '.step_fifty_two', 400, 'silicon_nitride.silane', 1) // T-CESL
    ...
    Deposition.generateChemicalVaporDepositionRecipe('wafer.' + componentName + '.beol_nine.step_seven', 'wafer.' + componentName + '.step_one_hundred_fourty_eight', 400, 'silicon_dioxide.silane') // Passivation layer deposition
    Deposition.generateChemicalVaporDepositionRecipe('wafer.' + componentName + '.step_one_hundred_fourty_eight', 'wafer.' + componentName + '.step_one_hundred_fourty_nine', 400, 'silicon_nitride.silane')
    Lithography.generatePhotolithographyRecipes('wafer.' + componentName + '.step_one_hundred_fourty_nine', 'wafer.' + componentName + '.step_one_hundred_fifty', 'novolac_resist', 'mask_set.' + componentName, true) // Define contact hole pattern in passivation layers
