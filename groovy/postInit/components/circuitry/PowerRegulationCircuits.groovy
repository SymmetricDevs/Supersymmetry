...
CIRCUIT_ASSEMBLER.recipeBuilder()
    ...
    .fluidInputs(fluid('phenolic_novolac_resin') * 200)
...
CIRCUIT_ASSEMBLER.recipeBuilder()
    ...
    .fluidInputs(fluid('soldering_alloy') * 72)
    .fluidInputs(fluid('phenolic_novolac_resin') * 200)
    .outputs(metaitem('component.protector_chip'))
    .duration(600)
    .EUt(VA[LV])
    .buildAndRegister()
...
CIRCUIT_ASSEMBLER.recipeBuilder()
    ...
    .inputs(metaitem('component.capacitor.film') * 2)
    .inputs(metaitem('component.transistor.alloy_junction') * 4)
    .inputs(metaitem('component.protector_chip'))
    .inputs(metaitem('component.op_amp'))
    .inputs(metaitem('component.zener_diode'))
