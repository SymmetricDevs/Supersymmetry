...
ItemStack stack2 = metaitem('susy:data_card.master_blueprint') * 1
stack2.setTagCompound(SusyRocketComponents.ROCKET_LUNAR_BLUEPRINT_DEFAULT.writeToNBT())
...
mods.susy.rocketCosts.add('soyuz', 'soyuz_verniers')
        .input(metaitem('large_fluid_cell.steel').withNbt(['Fluid': ['FluidName': 'mon_3', 'Amount': 8000]]) * 12)
...
BR.recipeBuilder()
    ...
    .fluidInputs(fluid('acetylacetone') * 3000)
    .outputs(metaitem('dustIridiumAcetylacetonate') * 4)
...
INDUCTION_FURNACE.recipeBuilder()
    .fluidInputs(fluid('weapons_grade_uranium') * 768)
    .inputs(metaitem('dustTinyMolybdenum') * 3)
    .fluidOutputs(fluid('uranium_molybdenum_alloy') * 816)
    .duration(180)
    .EUt(VA[HV])
    .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(metaitem('ingotUraniumMolybdenumAlloy') * 4)
    .inputs(metaitem('stickBoronCarbide'))
    .inputs(metaitem('plateBerylliumOxide') * 8)
    .inputs(ore('pipeTinyFluidHaynes230') * 20)
    .inputs(metaitem('electric.piston.ev') * 9)
    .inputs(metaitem('pipeTinyFluidTitanium') * 10)
    .inputs(metaitem('plateAluminium') * 8)
    .inputs(metaitem('cableGtDoubleSilver') * 8)
    .fluidInputs(fluid('distilled_water') * 4000)
    .fluidInputs(fluid('sodium') * 576)
    .outputs(item('susy:spacecraft_instrument', 7) * 1) // Nuclear reactor
    .duration(1000)
    .EUt(VA[EV])
    .buildAndRegister()

ASSEMBLER.recipeBuilder()
    .inputs(metaitem('susy:fuel_cell.ev') * 1)
    .inputs(metaitem('drum.titanium') * 2)
    .inputs(metaitem('plateAluminium') * 4)
    .inputs(metaitem('cableGtDoubleSilver') * 4)
    .inputs(metaitem('pipeSmallFluidStainlessSteel') * 4)
    .fluidInputs(fluid('liquid_hydrogen') * 2000)
    .fluidInputs(fluid('liquid_oxygen') * 2000)
    .outputs(item('susy:spacecraft_instrument', 9) * 1) // Fuel cell
    .duration(80)
    .EUt(VA[HV])
    .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
    .inputs(metaitem('hull.ev') * 1)
    .inputs(metaitem('carbon.tile.phenolic.treated') * 64)
    .inputs(metaitem('parachute.drogue') * 2)
    .inputs(metaitem('parachute.main') * 3)
    .inputs(metaitem('parachute.supersonic_main') * 3)
    .inputs(metaitem('springTitanium') * 6)
    .inputs(metaitem('plateAluminium') * 8)
    .inputs(metaitem('foilMetallizedBopet') * 20)
    .outputs(item('susy:spacecraft_instrument', 10) * 1) // Earth landing system
    .duration(800)
    .EUt(VA[EV])
    .buildAndRegister()

MILLING.recipeBuilder()
    .inputs(metaitem('ingotMolybdenum') * 1)
    .outputs(metaitem('molybdenum_combustion_chamber_mandrel') * 1)
    .circuitMeta(2)
    .duration(110)
    .EUt(VA[HV])
    .buildAndRegister()
...
CVD.recipeBuilder()
    .inputs(metaitem('molybdenum_combustion_chamber_mandrel') * 1)
    .inputs(metaitem('dustIridiumAcetylacetonate') * 1)
    .outputs(metaitem('iridium_combustion_chamber_mandrel') * 1)
    .duration(90)
    .EUt(VA[EV])
    .buildAndRegister()

CVD.recipeBuilder()
    .inputs(metaitem('iridium_combustion_chamber_mandrel') * 1)
    .inputs(metaitem('dustRheniumPentachloride') * 6)
    .outputs(metaitem('rhenium_combustion_chamber_mandrel') * 1)
...
BR.recipeBuilder()
    .inputs(metaitem('rhenium_combustion_chamber_mandrel') * 1)
    .fluidInputs(fluid('sulfuric_acid') * 1000)
    .outputs(metaitem('rhenium_combustion_chamber') * 1)
    .fluidOutputs(fluid('wastewater') * 1000)
    .duration(120)
    .EUt(VA[HV])
    .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
    .inputs(metaitem('rhenium_combustion_chamber') * 4)
    .inputs(metaitem('plateTitanium') * 2)
    .inputs(metaitem('large_fluid_cell.steel').withNbt(['Fluid': ['FluidName': 'mon_3', 'Amount': 8000]]) * 1)
    .inputs(metaitem('large_fluid_cell.steel').withNbt(['Fluid': ['FluidName': 'monomethylhydrazine', 'Amount': 8000]]) * 1)
    .inputs(metaitem('fluid_cell') * 1)
    .inputs(metaitem('pipeTinyFluidStainlessSteel') * 6)
    .fluidInputs(fluid('liquid_helium') * 200)
    .outputs(item('susy:spacecraft_instrument', 8) * 1) // Chemical thruster
    .duration(400)
    .EUt(VA[EV])
    .buildAndRegister()

MIXER.recipeBuilder()
    .fluidInputs(fluid('dimethylhydrazine') * 500)
    .fluidInputs(fluid('hydrazine') * 500)
    .fluidOutputs(fluid('aerozine_50') * 1000)
    .duration(50)
    .EUt(VA[LV])
    .buildAndRegister()

ASSEMBLER.recipeBuilder()
    .inputs(item('susy:rocket_combustion_chamber') * 1)
    .inputs(item('susy:rocket_nozzle') * 8)
    .inputs(metaitem('large_fluid_cell.stainless_steel').withNbt(['Fluid': ['FluidName': 'aerozine_50', 'Amount': 64000]]) * 1)
    .inputs(metaitem('large_fluid_cell.stainless_steel').withNbt(['Fluid': ['FluidName': 'mon_3', 'Amount': 64000]]) * 1)
    .inputs(metaitem('fluid_cell') * 1)
    .inputs(metaitem('pipeSmallFluidStainlessSteel') * 6)
    .inputs(metaitem('electric.pump.hv') * 6)
    .fluidInputs(fluid('liquid_helium') * 400)
    .outputs(metaitem('lunar_module_engine') * 1)
    .duration(400)
    .EUt(VA[EV])
    .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
    .inputs(item('susy:rocket_combustion_chamber') * 1)
    .inputs(item('susy:rocket_nozzle') * 16)
    .inputs(metaitem('pipeSmallFluidStainlessSteel') * 16)
    .inputs(item('susy:rocket_engine_gas_generator'))
    .inputs(item('susy:rocket_turbopump') * 2)
    .outputs(item('susy:spacecraft_instrument', 12)) // Main engine
    .duration(650)
    .EUt(VA[EV])
    .buildAndRegister()
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(metaitem('pipeSmallFluidStainlessSteel') * 16)
    .fluidInputs(fluid('mon_3') * 8000)
    .outputs(item('susy:spacecraft_instrument', 13)) // Ox tank
    .duration(400)
    .EUt(VA[EV])
    .buildAndRegister()
