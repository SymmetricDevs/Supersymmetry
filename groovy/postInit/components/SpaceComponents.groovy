...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(metaitem('plateTitanium') * 2)
    .inputs(metaitem('large_fluid_cell.steel').withNbt(['Fluid': ['FluidName': 'dinitrogen_tetroxide', 'Amount': 8000]]) * 1)
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(metaitem('large_fluid_cell.stainless_steel').withNbt(['Fluid': ['FluidName': 'dinitrogen_tetroxide', 'Amount': 64000]]) * 1)
    .inputs(metaitem('fluid_cell') * 1)
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(metaitem('pipeSmallFluidStainlessSteel') * 16)
    .fluidInputs(fluid('dinitrogen_tetroxide') * 8000)
