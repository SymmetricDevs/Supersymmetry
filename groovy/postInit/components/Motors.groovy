...
ASSEMBLER.recipeBuilder()
    ...
    .outputs(metaitem('wireFineEnameledCopper') * 16)
    .duration(80)
    .EUt(VA[MV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    ...
    .fluidInputs(fluid('polyethylene_terephthalate') * 36)
    .outputs(metaitem('wireFineEnameledGold') * 16)
    .duration(80)
    .EUt(VA[MV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(ore('plateAlnicoMagnetic') * 2)
    .inputs(ore('wireFineEnameledGold') * 16)
    .inputs(metaitem('component.commutator'))
    .inputs(metaitem('component.brush') * 2)
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(ore('plateAlnicoMagnetic') * 3)
    .inputs(ore('wireFineEnameledGold') * 32)
...
CVD.recipeBuilder()
    ...
    .outputs(metaitem('wireFineGrapheneCoatedGold') * 64)
    .duration(200)
    .EUt(VA[EV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    ...
    .fluidInputs(fluid('polyethylene_terephthalate') * 36)
    .outputs(metaitem('wireFineEnameledGrapheneCoatedGold') * 16)
    .duration(80)
    .EUt(VA[MV])
    .buildAndRegister();
...
ASSEMBLER.recipeBuilder()
    ...
    .inputs(ore('wireFineEnameledGrapheneCoatedGold') * 64)
