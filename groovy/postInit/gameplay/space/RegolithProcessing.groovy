...
BR.recipeBuilder()
    .fluidInputs(fluid("strong_anorthosite_leach") * 9000)
    .fluidInputs(fluid('hydrogen_chloride') * 1000)
    .outputs(metaitem("dustAluminiumChlorideHexahydrate") * 44)
    .fluidOutputs(fluid("supersaturated_calcium_chloride_solution") * 1000)
    .EUt(VA[LV])
    .duration(240)
    .buildAndRegister()
...
SOLAR_FURNACE.recipeBuilder()
    .inputs(metaitem("dustAluminiumChlorideHexahydrate") * 44)
...
SOLAR_FURNACE.recipeBuilder()
    .fluidInputs(fluid("supersaturated_calcium_chloride_solution") * 1000)
...
SOLAR_FURNACE.recipeBuilder()
    ...
    .fluidOutputs(fluid("calcium_chloride") * 144)
    .EUt(8000)
    .duration(32)
    .buildAndRegister()
...
ELECTROLYZER.recipeBuilder()
    ...
    .notConsumable(metaitem("stickMolybdenum")) //FIXME: add alternate lunar-native electrodes if possible (maybe at lower efficiency)
...
ELECTROSTATIC_SEPARATOR.recipeBuilder()
    .inputs(metaitem("dustLunarWeaklyMagnetic"))
    .chancedOutput(metaitem("dustHematite") * 1, 8000, 0)
    .chancedOutput(metaitem("dustIlmenite") * 1, 8000, 0) //FIXME: these abundances are all bullshit
...
BR.recipeBuilder()
    .inputs(metaitem("dustNativeLunarIron")) //FIXME (maybe): get cobalt from this if there's an easy way
    .fluidInputs(fluid("carbon_monoxide") * 240)
    .outputs(metaitem("dustIron"))
    .fluidOutputs(fluid("nickel_carbonyl") * 60)
    .duration(60)
    .EUt(7)
    .buildAndRegister()
...
ELECTROLYZER.recipeBuilder()
    .inputs(metaitem("dustLunarRutile") * 3)
    .notConsumable(metaitem("dustLunarRutile"))
    .notConsumable(metaitem("graphite_electrode"))
    .notConsumable(fluid("calcium_chloride") * 432)
...
BR.recipeBuilder()
    ...
    .fluidOutputs(fluid("lunar_sodium_aluminate_solution") * 4500)
    .EUt(VA[LV])
    .duration(400)
    .buildAndRegister()
...
BR.recipeBuilder()
    ...
    .fluidOutputs(fluid('impure_phosphoric_acid') * 15200)
...
MIXER_SETTLER.recipeBuilder()
    .fluidInputs(fluid('impure_phosphoric_acid') * 15200)
    .fluidInputs(fluid('methyl_isobutyl_ketone') * 4000)
    .fluidOutputs(fluid('waste_gypsum') * 15200)
