...
LCR.recipeBuilder()
    .inputs(ore('dustMercuryIiCyanide'))
    .fluidInputs(fluid('palladium_containing_solution') * 32000)
    .outputs(metaitem('dustPalladiumIiCyanide'))
    .fluidOutputs(fluid('diluted_ammonium_chloride_solution') * 16000)
    .duration(240)
    .EUt(Globals.voltAmps[3])
    .buildAndRegister()
