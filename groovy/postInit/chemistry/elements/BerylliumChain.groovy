...
BR.recipeBuilder() //Potassium permangante is typically added to oxidize iron II to III, however this may be too demanding for an MV line
        ...
        .fluidInputs(fluid('impure_beryllium_sulfate_solution') * 9000)
        .outputs(metaitem('dustIronIiiHydroxide'))
        .outputs(metaitem('dustChromiumIiiHydroxide'))
        .outputs(metaitem('dustGypsum') * 8)
        .fluidOutputs(fluid('beryllium_sulfate_solution') * 9000)
        .EUt(120)
        .duration(900)
        .buildAndRegister()
...
BR.recipeBuilder() //100% (Technically, it makes a little bit of ferric EDTA but I dont want to model it)
        ...
        .inputs(ore('dustTetrasodiumEthylenediaminetetraaceticAcid'))
        .fluidInputs(fluid('beryllium_sulfate_solution') * 2000)
        .outputs(metaitem('dustBerylliumHydroxide') * 24)
        .fluidOutputs(fluid('sodium_sulfate_solution') * 16000)
        .EUt(120)
        .duration(200)
        .buildAndRegister()
...
BR.recipeBuilder()
        ...
        .fluidInputs(fluid('ammonium_fluoroberyllate_solution') * 9000)
        .chancedOutput(metaitem('dustChromiumIiiHydroxide'), 200, 0)
        .chancedOutput(metaitem('dustIronIiiHydroxide'), 200, 0)
        .fluidOutputs(fluid('ammonium_fluoroberyllate_solution') * 9000)
        .EUt(Globals.voltAmps[2])
        .duration(900)
        .buildAndRegister()
