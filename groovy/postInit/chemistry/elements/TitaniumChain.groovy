...
CLARIFIER.recipeBuilder()
        ...
        .outputs(metaitem('dustImpureIlmeniteConcentrate') * 16)
...
ELECTROMAGNETIC_SEPARATOR.recipeBuilder()
        ...
        .chancedOutput(ore('dustMagnetite'), 1000, 250)
        .chancedOutput(ore('dustRutileConcentrate'), 1000, 250)
        .duration(20)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
...
ELECTROMAGNETIC_SEPARATOR.recipeBuilder()
        ...
        .chancedOutput(ore('dustZircon'), 1000, 250)
        .duration(20)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
...
FIXED_BED_REACTOR.recipeBuilder()
        ...
        .chancedOutput(ore('dustVanadiumOxydichloride'), 6000, 500)
        .duration(200)
        .EUt(Globals.voltAmps[2])
        .buildAndRegister()
...
DISTILLATION_TOWER.recipeBuilder()
        ...
        .chancedOutput(ore('dustIronIiiChloride'), 2000, 250)
        .duration(300)
        .EUt(Globals.voltAmps[2] * 2)
        .buildAndRegister()
...
MACERATOR.recipeBuilder()
        ...
        .chancedOutput(ore('dustTitanium'), 8500, 0)
        .duration(100)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
