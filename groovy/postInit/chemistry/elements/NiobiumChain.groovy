...
ROASTER.recipeBuilder() // Roasted Pyrochlore
    ...
    .outputs(ore('dustRoastedPyrochlore') * 16)
    .duration(20)
    .EUt(Globals.voltAmps[1])
    .buildAndRegister()
...
AUTOCLAVE.recipeBuilder() // Impure Fluoroniobic Acid Solution
    ...
    .fluidOutputs(fluid('impure_fluoroniobic_acid_solution') * 20000)
    .duration(80)
    .EUt(Globals.voltAmps[3])
    .buildAndRegister()

CENTRIFUGE.recipeBuilder() // Niobium-rich Extract
    .fluidInputs(fluid('impure_fluoroniobic_acid_solution') * 20000)
...
ROASTER.recipeBuilder()
    ...
    .chancedOutput(metaitem('dustIronIiSulfate') * 6, 5000, 0)
