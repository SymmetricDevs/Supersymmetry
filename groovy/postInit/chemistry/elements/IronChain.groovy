...
for (blastable in blastables) {
    for (combustible in combustibles) {
        ...
        .inputs(ore(combustible.name) * (combustible.amount * blastable.reductant_required))
        .outputs(metaitem('ingotPigIron') * blastable.amount_produced)
        .outputs(metaitem(combustible.byproduct) * (combustible.amount * blastable.reductant_required))
