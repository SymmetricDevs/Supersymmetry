...
BALL_MILL.recipeBuilder()
    ...
    SINTERING_OVEN.recipeBuilder()
        ...
        .fluidInputs(fluid('nickel_nitrate_solution') * 100)
        .fluidInputs(fluid('hydrogen') * 100)
        .outputs(metaitem('dustSupportedNickel'))
        .fluidOutputs(fluid('diluted_nitric_acid') * 200)
        .duration(100)
        .EUt(VA[LV])
        .buildAndRegister()
    ...
    SINTERING_OVEN.recipeBuilder()
        .inputs(ore('dustFineGammaAlumina') * 5)
        .fluidInputs(fluid('silver_nitrate_solution') * 100)
        .fluidInputs(fluid('ammonia_solution') * 200)
        .outputs(metaitem('dustSupportedSilver'))
        .duration(100)
        .EUt(VA[LV])
        .buildAndRegister()
    ...
    SINTERING_OVEN.recipeBuilder()
        .inputs(ore('dustFineGammaAlumina') * 5)
        .fluidInputs(fluid('chromium_iii_nitrate_solution') * 300)
        .fluidInputs(fluid('hydrogen_fluoride') * 100)
        .outputs(metaitem('dustSupportedChromiumIiiOxide'))
        .duration(100)
        .EUt(VA[LV])
        .buildAndRegister()
    ...
    SINTERING_OVEN.recipeBuilder()
        .inputs(ore('dustFineGammaAlumina') * 5)
        .fluidInputs(fluid('ammonium_molybdate_solution') * 100)
        .inputs(ore('dustAmmoniumMetavanadate'))
        .outputs(metaitem('dustSupportedMolybdenumVanadiumOxide'))
        .duration(200)
        .EUt(VA[MV])
        .buildAndRegister()
...
// Olefin condensation catalysts
    ...
    BR.recipeBuilder()
        ...
        .fluidInputs(fluid('nitric_acid') * 2000)
        .fluidOutputs(fluid('cobalt_ii_nitrate_solution') * 1000)
        .duration(60)
        .EUt(VA[LV])
        .buildAndRegister()
    ...
    ROASTER.recipeBuilder()
        ...
        .fluidInputs(fluid('cobalt_ii_nitrate_solution') * 2000)
...
FIXED_BR.recipeBuilder()
        .notConsumable(metaitem('catalystBedAmmoxidationCatalyst'))
        .fluidInputs(fluid('toluene') * 1000)
        .fluidInputs(fluid('ammonia') * 1000)
        .fluidInputs(fluid('oxygen') * 3000)
        .fluidOutputs(fluid('benzonitrile') * 1000)
...
MIXER.recipeBuilder()
        .inputs(metaitem('dustPalladiumChloride') * 3)
        .fluidInputs(fluid('benzonitrile') * 2000)
        .outputs(metaitem('dustBisBenzonitrilePalladiumIiChloride') * 29)
        .EUt(VA[LV])
        .duration(72)
        .buildAndRegister()
