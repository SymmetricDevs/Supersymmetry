...
ZONE_REFINER.recipeBuilder() // FIXME: Add an electron beam metaitem for this recipe, also use it for E-beam litho machine recipe
    .inputs(ore('ingotTungsten'))
    .outputs(metaitem('ingotHighPurityTungsten'))
    .duration(400)
    .EUt(VA[EV])
    .buildAndRegister()

ROASTER.recipeBuilder()
    .inputs(ore('ingotHighPurityTungsten'))
    .fluidInputs(fluid('fluorine') * 6000)
    .fluidOutputs(fluid('tungsten_hexafluoride') * 6000)
    .duration(200)
    .EUt(VA[MV])
    .buildAndRegister()

ROASTER.recipeBuilder()
    .inputs(ore('dustTungsten'))
