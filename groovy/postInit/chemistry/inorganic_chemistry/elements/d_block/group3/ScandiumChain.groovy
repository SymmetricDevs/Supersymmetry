...
MIXER_SETTLER.recipeBuilder()
    ...
    .fluidOutputs(fluid('scandium_p204_extract') * 1000)
    .requiredCells(4)
    .EUt(VA[EV])
    .duration(200)
    .buildAndRegister()
...
BR.recipeBuilder()
    .fluidInputs(fluid('purified_scandium_p204_extract') * 12000)
...
BR.recipeBuilder()
    .inputs(metaitem('dustScandiumOxide') * 5)
    .fluidInputs(fluid('hydrofluoric_acid') * 6000)
    .outputs(metaitem('dustScandiumIiiFluoride') * 8)
