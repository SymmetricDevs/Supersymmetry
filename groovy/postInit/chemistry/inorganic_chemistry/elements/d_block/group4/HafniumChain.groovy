...
SOLIDIFIER.recipeBuilder()
    .fluidInputs(fluid('hafnium_tetrachloride') * 720)
    .outputs(metaitem('dustHafniumTetrachloride') * 5)
    .duration(100)
    .EUt(VA[LV])
    .buildAndRegister()

BR.recipeBuilder()
    .inputs(ore('dustHafniumTetrachloride') * 5)
    .fluidInputs(fluid('lithium_dimethylamide_solution') * 4000)
    .outputs(metaitem('dustLithiumChloride') * 8)
    .fluidOutputs(fluid('tetrakis_dimethylamido_hafnium_solution') * 4000)
    .duration(200)
    .EUt(VA[MV])
    .buildAndRegister()

VACUUM_DT.recipeBuilder()
    .fluidInputs(fluid('tetrakis_dimethylamido_hafnium_solution') * 4000)
    .fluidOutputs(fluid('tetrakis_dimethylamido_hafnium') * 1000)
    .fluidOutputs(fluid('diethyl_ether') * 4000)
    .duration(200)
    .EUt(VA[MV])
    .buildAndRegister()