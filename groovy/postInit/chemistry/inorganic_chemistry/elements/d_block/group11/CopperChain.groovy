...
METALLURGICAL_CONVERTER.recipeBuilder()
    ...
    .fluidInputs(fluid('natural_gas') * 500)
...
BR.recipeBuilder()
    ...
    .fluidOutputs(fluid('copper_ii_nitrate_solution') * 1000)
    .EUt(VA[MV])
    .duration(80)
    .buildAndRegister()

DISTILLERY.recipeBuilder()
    .fluidInputs(fluid('copper_ii_nitrate_solution') * 1000)
    .outputs(metaitem('dustCopperIiNitrate') * 9)
