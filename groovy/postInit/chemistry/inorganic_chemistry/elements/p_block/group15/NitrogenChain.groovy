...
BR.recipeBuilder()
    ...
    .fluidOutputs(fluid('sodium_amide') * 576)
    .EUt(VA[MV])
    .duration(200)
    .buildAndRegister()
...
BCR.recipeBuilder()
    ...
    .fluidOutputs(fluid('crude_azide') * 1008)
    .fluidOutputs(fluid('ammonia') * 1000)
    .EUt(VA[MV])
    .duration(200)
    .buildAndRegister()
...
BR.recipeBuilder()
    ...
    .fluidInputs(fluid('water') * 1000)
    .fluidOutputs(fluid('crude_azide_solution') * 1000)
    .EUt(VA[MV])
    .duration(200)
    .buildAndRegister()

VACUUM_DT.recipeBuilder()
    .fluidInputs(fluid('crude_azide_solution') * 1000)
    .outputs(metaitem('dustSodiumAzide') * 4)
