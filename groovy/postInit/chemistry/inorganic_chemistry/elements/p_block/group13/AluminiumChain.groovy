...
ROASTER.recipeBuilder()
    ...
    .fluidOutputs(fluid('bauxite_leach') * 3500)
...
CENTRIFUGE.recipeBuilder()
    .fluidInputs(fluid('bauxite_leach') * 3500)
...
CRYSTALLIZER.recipeBuilder()
    .fluidInputs(fluid('impure_sodium_aluminate_solution') * 1500)
...
Carbons.dusts().grep(Carbons.HighPurityCombustible).each { carbon ->
    ELECTROLYTIC_CELL.recipeBuilder()
        ...
        .notConsumable(ore('dustAluminiumFluoride') * 4)
...
ROASTER.recipeBuilder()
    ...
    .outputs(metaitem('dustAluminiumFluoride') * 8)
    .duration(300)
    .EUt(16)
    .buildAndRegister()
...
ROASTER.recipeBuilder()
    .inputs(ore('dustAluminiumFluoride') * 4)
...
MIXER.recipeBuilder()
    ...
    .inputs(ore('dustAluminiumFluoride') * 8)
...
// Aluminium chlorofluoride (strong Lewis acid catalyst)

BR.recipeBuilder()
    .inputs(ore('dustAluminiumChloride') * 4)
    .fluidInputs(fluid('trichlorofluoromethane') * 130)
    .outputs(metaitem('dustAluminiumChlorofluoride') * 4)
    .fluidOutputs(fluid('carbon_tetrafluoride') * 130)
    .duration(100)
    .EUt(VA[MV])
    .buildAndRegister()