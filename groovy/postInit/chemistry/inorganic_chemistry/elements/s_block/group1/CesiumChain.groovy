...
CLARIFIER.recipeBuilder()
    ...
    .outputs(metaitem('dustPollucite') * 8)
...
CRYSTALLIZER.recipeBuilder()
    ...
    .outputs(metaitem('dustCaesiumRubidiumAlumMix'))
    .EUt(Globals.voltAmps[2])
    .duration(80)
    .buildAndRegister()
...
CRYSTALLIZER.recipeBuilder()
    .inputs(ore('dustCaesiumRubidiumAlumMix'))
    .fluidOutputs(fluid('gtfo_heated_water') * 10000)
    .chancedOutput(metaitem('dustCaesiumAlum') * 12, 9500)
