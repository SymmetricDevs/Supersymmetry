...
ROASTER.recipeBuilder()
        .inputs(ore('dustMagnesiumCarbonate') * 7)
        .outputs(metaitem('dustMagnesia') * 2)
        .fluidOutputs(fluid('carbon_dioxide') * 1000)
        .EUt(VA[LV])
        .duration(120)
...
ROASTER.recipeBuilder()
        ...
        .outputs(metaitem('dustMagnesia') * 1)
        .outputs(metaitem('dustQuicklime') * 1)
        .fluidOutputs(fluid('carbon_dioxide') * 1000)
        .EUt(VA[LV])
        .duration(120)
        .buildAndRegister()
...
LCR.recipeBuilder()
        ...
        .fluidOutputs(fluid('magnesium_chloride_solution') * 10000)
        .fluidOutputs(fluid('carbon_dioxide') * 5000)
