...
MIXER.recipeBuilder()
    .inputs(metaitem('dustSodiumSilicate') * 6)
...
MIXER.recipeBuilder()
    ...
    .fluidOutputs(fluid('sodium_aluminate_solution') * 1500)
    .duration(160)
    .EUt(VA[LV])
    .buildAndRegister()
