...
POLYMERIZATION.recipeBuilder()
    ...
    .inputs(ore('dustTinyPotassiumPersulfate'))
    .fluidOutputs(fluid('polyethylene_vinyl_acetate_mixture') * 2000)
    .duration(150)
    .EUt(60)
    .buildAndRegister()

PHASE_SEPARATOR.recipeBuilder()
    .fluidInputs(fluid('polyethylene_vinyl_acetate_mixture') * 2000)
    .outputs(metaitem('dustPolyethyleneVinylAcetate') * 7)
    .fluidOutputs(fluid('methanol') * 1000)
    .duration(50)
    .buildAndRegister()
