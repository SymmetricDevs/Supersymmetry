...
BR.recipeBuilder()
    ...
    .fluidInputs(fluid('ethanol') * 9000)
    .fluidOutputs(fluid('sodium_cmc_suspension') * 14000)
    .duration(240)
    .EUt(VA[MV])
    .buildAndRegister()

CENTRIFUGE.recipeBuilder()
    .fluidInputs(fluid('sodium_cmc_suspension') * 14000)
    .outputs(metaitem('dustSodiumCarboxymethylCellulose') * 4)
    .fluidOutputs(fluid('sodium_cmc_suspension_medium') * 14000)
    .duration(240)
    .EUt(VA[MV])
    .buildAndRegister()

BCR.recipeBuilder()
    .fluidInputs(fluid('sodium_cmc_suspension_medium') * 14000)
    .fluidInputs(fluid('hydrogen_chloride') * 1000)
    .fluidOutputs(fluid('acidic_sodium_cmc_suspension_medium') * 14000)
    .duration(120)
    .EUt(VA[MV])
    .buildAndRegister()

DT.recipeBuilder()
    .fluidInputs(fluid('acidic_sodium_cmc_suspension_medium') * 14000)
    .fluidOutputs(fluid('ethanol_water_azeotrope') * 10000)
    .fluidOutputs(fluid('salty_diluted_glycolic_acid') * 4000)
    .duration(120)
    .EUt(VA[MV])
    .buildAndRegister()

CRYSTALLIZER.recipeBuilder()
    .fluidInputs(fluid('salty_diluted_glycolic_acid') * 4000)
    .outputs(metaitem('dustSalt') * 12)
    .outputs(metaitem('dustGlycolicAcid') * 9)
