...
crackables.each { _, crackable -> {
        if (crackable.catalytic_crackable) {
            CRACKER.recipeBuilder()
                ...
                .fluidOutputs(fraction.getCrudeCatalyticallyCracked(1000))
                .duration(200)
                .EUt(Globals.voltAmps[1] * 2)
                .buildAndRegister()

            BCR.recipeBuilder()
                .fluidInputs(fraction.getCrudeCatalyticallyCracked(500))
...
DT.recipeBuilder()
    ...
    .fluidOutputs(crackables.heavy_cycle_oil.get(40))
    .fluidOutputs(crackables.light_cycle_oil.get(60))
