...
DT.recipeBuilder()
    .fluidInputs(fractions.kerosene.getCrude(1000))
    //.fluidInputs(fluid('dense_steam') * 1000)
    .fluidOutputs(fractions.kerosene.getSulfuric(1000))
...
DT.recipeBuilder()
    .fluidInputs(fractions.diesel.getCrude(1000))
    //.fluidInputs(fluid('dense_steam') * 1000)
    .fluidOutputs(fractions.diesel.getSulfuric(1000))
    .fluidOutputs(fluid('wastewater') * 1000)
    .duration(20)
    .EUt(30)
    .buildAndRegister()
...
DT.recipeBuilder()
    .fluidInputs(fractions.fuel_oil.getCrude(1000))
    //.fluidInputs(fluid('dense_steam') * 1000)
    .fluidOutputs(fractions.fuel_oil.getSulfuric(1000))
    .fluidOutputs(fluid('wastewater') * 1000)
    .duration(20)
    .EUt(30)
    .buildAndRegister()
...
PHASE_SEPARATOR.recipeBuilder()
    ...
    .fluidOutputs(fluid('crude_naphtha') * 3500)
    .fluidOutputs(fluid('wastewater') * 10000)
    .duration(400)
    .buildAndRegister()
