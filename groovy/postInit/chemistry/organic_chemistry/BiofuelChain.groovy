...
// Linoleic Acid extraction
FLUID_EXTRACTOR.recipeBuilder()
    .circuitMeta(1)
    .inputs(metaitem('gregtechfoodoption:seed.cotton') * 1)
    .outputs(metaitem('dustSmallWood'))
    .fluidOutputs(fluid('linoleic_acid') * 20)
    .duration(30)
    .EUt(32)
    .buildAndRegister()
...
FLUID_EXTRACTOR.recipeBuilder()
    .circuitMeta(4)
    .inputs(metaitem('gregtechfoodoption:seed.soy') * 1)
    .outputs(metaitem('dustSmallWood'))
    .fluidOutputs(fluid('linoleic_acid') * 25)
    .duration(30)
    .EUt(32)
    .buildAndRegister()
