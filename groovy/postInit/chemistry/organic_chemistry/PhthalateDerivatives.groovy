...
CSTR.recipeBuilder()
    ...
    .outputs(metaitem('dustTetrabromomethane') * 5)
    .EUt(120)
    .duration(3)
    .buildAndRegister()
...
MIXER.recipeBuilder()
    ...
    .inputs(ore('dustTetrabromomethane') * 5)
...
MIXER.recipeBuilder()
    ...
    .fluidOutputs(fluid('crude_terephthalic_acid_solution') * 1000)
    .EUt(30)
    .duration(100)
    .buildAndRegister()
...
MIXER.recipeBuilder()
    ...
    .fluidInputs(fluid('gtfo_heated_water') * 1000)
    .fluidOutputs(fluid('crude_isophthalic_acid_solution') * 1000)
    .EUt(30)
    .duration(100)
    .buildAndRegister()
...
TBR.recipeBuilder()
    ...
    .fluidInputs(fluid('crude_terephthalic_acid_solution') * 1000)
    .fluidInputs(fluid('hydrogen') * 15)
    .fluidOutputs(fluid('hydrogenated_terephthalic_acid_solution') * 1005)
    .EUt(120)
    .duration(100)
    .buildAndRegister()
...
TBR.recipeBuilder()
    .notConsumable(ore('dustPalladiumOnCarbon'))
    .fluidInputs(fluid('crude_isophthalic_acid_solution') * 1000)
    .fluidInputs(fluid('hydrogen') * 15)
    .fluidOutputs(fluid('hydrogenated_isophthalic_acid_solution') * 1005)
    .EUt(120)
    .duration(100)
    .buildAndRegister()

CRYSTALLIZER.recipeBuilder()
    .fluidInputs(fluid('hydrogenated_terephthalic_acid_solution') * 1005)
...
CRYSTALLIZER.recipeBuilder()
    .fluidInputs(fluid('hydrogenated_isophthalic_acid_solution') * 1005)
