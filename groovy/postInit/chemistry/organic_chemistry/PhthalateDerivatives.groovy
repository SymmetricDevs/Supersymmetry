...
LCR.recipeBuilder()
    ...
    .fluidInputs(fluid('acetic_acid') * 2000)
    .notConsumable(metaitem('dustAmocoProcessCatalyst'))
    .fluidOutputs(fluid('isophthalic_acid_slurry') * 4000)
    .EUt(VA[EV])
    .duration(200)
    .buildAndRegister()
...
SIFTER.recipeBuilder()
    ...
    .fluidInputs(fluid('isophthalic_acid_slurry') * 4000)
...
SIFTER.recipeBuilder()
    .notConsumable(metaitem('item_filter'))
    .fluidInputs(fluid('terephthalic_acid_slurry') * 4000)
