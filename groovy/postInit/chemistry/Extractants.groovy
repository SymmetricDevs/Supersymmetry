...
DISTILLATION_TOWER.recipeBuilder()
        ...
        .fluidOutputs(fluid('water') * 1901)
        .fluidOutputs(fluid('nitric_acid') * 4000)
        .fluidOutputs(fluid('ethanol_water_azeotrope') * 1099)
        .duration(160)
        .EUt(120)
        .buildAndRegister()
...
BR.recipeBuilder()
        .fluidInputs(fluid('triethylaluminium') * 454)
        .fluidInputs(fluid('ethylene') * 11619)
        .fluidInputs(fluid('diethyl_ether') * 500)
        .fluidOutputs(fluid('trialkylaluminium_mixture') * 500)
        .duration(200)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
...
POLYMERIZATION.recipeBuilder()
        .circuitMeta(1)
        .fluidInputs(fluid('polystyrene') * 4000)
        .fluidInputs(fluid('divinylbenzene') * 4000)
        .inputs(ore('dustPotassiumPersulfate'))
        .fluidOutputs(fluid('crosslinked_polystyrene') * 4032)
        .EUt(120)
        .duration(400)
        .buildAndRegister()
...
POLYMERIZATION.recipeBuilder()
        .inputs(ore('dustPalladium') * 4)
        .fluidInputs(fluid('polystyrene') * 2000)
        .fluidInputs(fluid('divinylbenzene') * 2000)
        .inputs(ore('dustPotassiumPersulfate'))
        .fluidOutputs(fluid('palladium_doped_crosslinked_polystyrene') * 2016)
        .EUt(120)
        .duration(160)
        .buildAndRegister()
