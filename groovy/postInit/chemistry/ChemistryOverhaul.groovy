...
.fluidOutputs(fluid('antimony_pentachloride') * 1000)
.duration(60)
.EUt(30)
.buildAndRegister()

BR.recipeBuilder()
.fluidInputs(fluid('antimony_pentachloride') * 1000)
...
.fluidInputs(fluid('antimony_pentafluoride') * 1000)
.fluidOutputs(fluid('sodium_hexafluoroantimonate_solution') * 1000)
.duration(200)
.EUt(480)
.buildAndRegister()
