...
BR.recipeBuilder()
        ...
        .inputs(ore('dustSodiumHydroxide') * 3)
        .fluidOutputs(fluid('tetrasodium_ethylenediaminetetraacetate_solution') * 2000)
        .duration(300)
        .EUt(30)
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('tetrasodium_ethylenediaminetetraacetate_solution') * 8000)
        .fluidOutputs(fluid('diluted_saltwater') * 8000)
        .outputs(metaitem('dustTetrasodiumEthylenediaminetetraacetate') * 44)
        .duration(300)
        .EUt(30)
        .buildAndRegister()
