...
.fluidInputs(fluid('dimethyldichlorosilane_emulsion') * 12000)
.inputs(ore('dustPotassiumPersulfate'))
.outputs(metaitem('dustPolydimethylsiloxane') * 12)
...
MIXER.recipeBuilder()
.fluidInputs(fluid('water') * 1000)
.inputs(ore('dustPerfluorooctanoicAcid') * 26)
...
MIXER.recipeBuilder()
.fluidInputs(fluid('tetrafluoroethylene') * 3000)
.fluidInputs(fluid('fluorinated_surfactant_mixture') * 1000)
.fluidOutputs(fluid('tetrafluoroethylene_emulsion') * 4000)
.duration(200)
.EUt(30)
.buildAndRegister()

POLYMERIZATION.recipeBuilder()
.fluidInputs(fluid('tetrafluoroethylene_emulsion') * 4000)
.inputs(ore('dustPotassiumPersulfate'))
.fluidOutputs(fluid('polytetrafluoroethylene_solution') * 8000)
.duration(600)
.EUt(240)
.buildAndRegister()

DRYER.recipeBuilder()
.fluidInputs(fluid('polytetrafluoroethylene_solution') * 4000)
.outputs(metaitem('dustPolytetrafluoroethylene') * 21)
...
POLYMERIZATION.recipeBuilder()
.fluidInputs(fluid('vinyl_chloride_suspension') * 8000)
.inputs(ore('dustPotassiumPersulfate'))
.fluidOutputs(fluid('polyvinyl_chloride_suspension') * 8000)
.duration(600)
.EUt(60)
.buildAndRegister()
...
POLYMERIZATION.recipeBuilder()
.fluidInputs(fluid('styrene_solution') * 8000)
.inputs(ore('dustPotassiumPersulfate'))
.fluidOutputs(fluid('polystyrene_solution') * 8000)
.duration(600)
.EUt(60)
.buildAndRegister()
...
POLYMERIZATION.recipeBuilder()
.fluidInputs(fluid('vinyl_acetate_solution') * 8000)
.inputs(ore('dustPotassiumPersulfate'))
.fluidOutputs(fluid('polyvinyl_acetate_solution') * 8000)
.duration(600)
.EUt(60)
.buildAndRegister()
...
ROASTER.recipeBuilder()
    ...
    .fluidInputs(fluid('chlorine') * 2000)
    .outputs(metaitem('dustTriphenylPhosphineDichloride') * 36)
    .duration(100)
    .EUt(Globals.voltAmps[1])
    .buildAndRegister()
...
LCR.recipeBuilder()
    ...
    .outputs(metaitem('dustBistriphenylphosphineiminiumChloride') * 35)
    .fluidOutputs(fluid('hydrogen_chloride') * 4000)
    .outputs(metaitem('dustTriphenylphosphineOxide') * 17)
    .duration(100)
    .EUt(Globals.voltAmps[1])
    .buildAndRegister()
...
MIXER.recipeBuilder()
    ...
    .outputs(metaitem('dustRaneyNickel') * 8)
    .duration(200)
    .EUt(Globals.voltAmps[1])
    .buildAndRegister()
...
// PMMA Solution
POLYMERIZATION.recipeBuilder()
        .fluidInputs(fluid('methyl_methacrylate_emulsion') * 8000)
        .inputs(ore('dustPotassiumPersulfate'))
        .fluidOutputs(fluid('polymethyl_methacrylate_solution') * 8000)
        .duration(600)
        .EUt(30)
        .buildAndRegister()
