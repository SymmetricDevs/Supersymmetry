...
BR.recipeBuilder()
        ...
        .fluidOutputs(fluid('nickel_ii_nitrate_solution') * 1000)
        .duration(20)
        .EUt(30)
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('nickel_ii_nitrate_solution') * 1000)
...
CSTR.recipeBuilder()
        .fluidInputs(fluid('diethylaluminium_acetylacetonate') * 50)
        .fluidInputs(fluid('hydrochloric_acid') * 150)
        .fluidOutputs(fluid('aluminium_chloride_solution') * 150)
        .fluidOutputs(fluid('acetylacetone') * 50)
        .fluidOutputs(fluid('ethylene') * 1000)
        .duration(8)
        .EUt(30)
        .buildAndRegister()
...
CSTR.recipeBuilder()
        ...
        .fluidOutputs(fluid('diphenylphospinoacetic_acid') * 50)
        .duration(10)
        .EUt(Globals.voltAmps[1])
        .buildAndRegister()
