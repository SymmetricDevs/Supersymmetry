...
BR.recipeBuilder()
    .fluidInputs(fluid('hydrogen_peroxide_solution') * 3000)
    .fluidInputs(fluid('acetone') * 3000)
    .fluidInputs(fluid('hydrochloric_acid') * 1500)
    .fluidOutputs(fluid('diluted_hydrochloric_acid') * 3000)
    .outputs(metaitem('dustTriacetonePeroxide') * 33)
    .duration(20)
    .EUt(30)
    .buildAndRegister()
...
BR.recipeBuilder()
    ...
    .outputs(metaitem('dustDiacetonePeroxide') * 22)
