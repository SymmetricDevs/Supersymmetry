...
BR.recipeBuilder()
        ...
        .inputs(ore('dustSodiumHydroxide') * 3)
        .fluidOutputs(fluid('tetrasodium_ethylenediaminetetraacetic_acid_solution') * 2000)
        .duration(300)
        .EUt(30)
        .buildAndRegister()

DISTILLERY.recipeBuilder()
        .fluidInputs(fluid('tetrasodium_ethylenediaminetetraacetic_acid_solution') * 8000)
