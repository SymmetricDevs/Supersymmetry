...
CSTR.recipeBuilder()
    ...
    .fluidOutputs(fluid('diacetone_peroxide_slurry') * 10)
    .fluidOutputs(fluid('diluted_sulfuric_acid') * 40)
    .duration(1)
    .EUt(30)
    .buildAndRegister()

DT.recipeBuilder()
    .fluidInputs(fluid('triacetone_peroxide_slurry') * 1000)
    .fluidOutputs(fluid('water') * 500)
    .outputs(metaitem('dustTriacetonePeroxide'))
    .duration(20)
    .EUt(30)
    .buildAndRegister()

DT.recipeBuilder()
    .fluidInputs(fluid('diacetone_peroxide_slurry') * 1000)
    .fluidOutputs(fluid('water') * 500)
