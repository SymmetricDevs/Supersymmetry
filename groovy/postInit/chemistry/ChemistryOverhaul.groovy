...
// Step 1: Creating impure 1,4-diiodobenzene
LCR.recipeBuilder()
...
// Step 2: Purifying 1,4-diiodobenzene
CENTRIFUGE.recipeBuilder()
...
BR.recipeBuilder()
    ...
    .inputs(ore('dustHighPuritySodium') * 3)
...
DRYER.recipeBuilder()
    ...
    .outputs(metaitem('dustSodiumSulfate') * 7)
    .outputs(metaitem('dustPropaneOneThreeSultone') * 144)
    .fluidOutputs(fluid('water') * 4000)
    .duration(200)
    .EUt(VA[LV])
    .buildAndRegister()
